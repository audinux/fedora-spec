...
git://git.code.sf.net/p/rakarrack/code
...
git://git.savannah.gnu.org/denemo
git://git.sv.gnu.org/ll-plugins/azr3-jack
git://git.tuxfamily.org/gitroot/non/fltk
git://git.tuxfamily.org/gitroot/non/non
git://liblo.git.sourceforge.net/gitroot/liblo/liblo
git://repo.or.cz/juce-lv2
