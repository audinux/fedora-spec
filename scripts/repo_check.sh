...
https://github.com/babelouest/%{name}
...
https://github.com/CoffeeVCV/CoffeeVCV/blob/master/README.md
https://github.com/ContemporaryInsanity/RacketScience
...
https://github.com/desbma/r128gain.git
...
https://github.com/Houston4444/plujain-ramp.git
...
https://github.com/Qirky/%{name}
https://github.com/raboof/%{gitname}
...
https://github.com/stump/%{name}
https://github.com/sumpygump/quantal-audio
https://github.com/supercollider-quarks/%{name}
...
https://github.com/VCVRack/VCV-Recorder.git
