...
# ./zl-source.sh ZLWarm 0.2.1

Source0: ZLWarm.tar.gz
...
sed -i -e "s/ZL Warm/ZL_Warm/g" CMakeLists.txt
...
cp -ra %{__cmake_builddir}/ZLWarm_artefacts/VST3/* %{buildroot}%{_libdir}/vst3/
