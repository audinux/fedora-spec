...
Package foam-synth from file ../foam-synth/foam-synth.spec is missing (status: active)
...
Package tunefish from file ../tunefish/tunefish.spec is missing (status: active)
