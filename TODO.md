...
Package allex-k-synth from file ../allex-k-synth/allex-k-synth.spec is missing (status: active) - webkit2gtk3-devel to remove
Package ddsp from file ../ddsp/ddsp.spec is missing (status: inactive) - webkit2gtk3 to remove
...
Package infernal-synth from file ../infernal-synth/infernal-synth.spec is missing (status: inactive) - inactive
Package ChowMultiTool from file ../kloncentaur/chowmultitool.spec is missing (status: active) - webkitgtk to remove
Package hexosynth from file ../templates/rust.spec is missing (status: active) - rust syntax error
Package lv2-freeze from file ../freeze/freeze.spec is missing (status: active) - debug symbols package problem
Package lv2-loopor from file ../loopor/loopor.spec is missing (status: active) - debug symbols package problem
Package openFrameworks from file ../openframeworks/openframeworks.spec is missing (status: active) - ld not found
Package rack-v1-ArableInstruments from file ../rack/rack-v1/rack-v1-library-ArableInstruments.spec is missing (status: active) - %patchN is obsolete
Package rack-v1-sfjack from file ../rack/rack-v1/rack-v1_05_skjack.spec is missing (status: active) - %patchN is obsolete
Package rack-v2-Bidoo from file ../rack/rack-v2/rack-v2-library-Bidoo.spec is missing (status: active) - %patchN is obsolete
Package rack-v2-FrequencyDomain from file ../rack/rack-v2/rack-v2-library-FrequencyDomain.spec is missing (status: active) - -Wtemplate-body
Package rack-v2-squinkylabs-plug1 from file ../rack/rack-v2/rack-v2-library-squinkylabs-plug1.spec is missing (status: active) - fixable by adding ‘#include <cstdint>
...
Package rack-v1-STS - no more sources (status: inactive)
Package rack-v1-SunsetSignals - no more sources (status: inactive)
Package rack-v1-TheXOR_plugin - no more sources (status: inactive)
Package rack-v1-aP-Modules - wrong VCV API (status: inactive)
Package rack-v1-arjo_modules - wrong VCV API (status inactive)
Package rack-v1-BaconMusic - wrong VCV API (status inactive)
Package rack-v1-BeckstromResearch -  wrong VCV API (status inactive)
Package rack-v1-BOKONTEPByteBeatMachine - wrong VCV API (status inactive)
Package rack-v1-CaptainsSounds - util.h not found (status inactive)
Package rack-v1-com-soundchasing-stochasm - wrong VCV API (status inactive)
Package rack-v1-ErraticInstruments - widgets.hpp not found (status inactive)
Package rack-v1-Gratrix - wrong VCV API (status inactive)
Package rack-v1-mtsch-plugins - wrong VCV API (status inactive)
Package rack-v1-NauModular - wrong VCV API (status inactive)
Package rack-v1-PG-Instruments - wrong VCV API (status inactive)
Package rack-v1-PvC - wrong VCV API (status inactive)
Package rack-v1-Quadraphonics - wrong VCV API (status inactive)
Package rack-v1-RODENTMODULES - wrong VCV API (status inactive)
Package rack-v1-SerialRacker - wrong VCV API (status inactive)
Package rack-v1-Southpole-parasites - wrong VCV API (status inactive)
Package rack-v1-SubmarineUtility - wrong VCV API (status inactive)
Package rack-v1-UnforgettableLuncheon -  wrong VCV API (status inactive)
Package rack-v2-Koralfx-Modules - no more sources (status: active)
Package rack-v2-TheXOR - no more sources (status: active)
Package rack-v2-Southpole - wrong VCV API (status: active)
Package rack-v2-luckyxxl - wrong VCV API (status: active)
Package rack-v2-23volts - wrong VCV API (status: active)
Package rack-v2-aP-Modules - wrong VCV API (status: active)
Package rack-v2-AriaSalvatrice - wrong VCV API (status: active)
Package rack-v2-arjo_modules - wrong VCV API (status: active)
Package rack-v2-BeckstromResearch - wrong VCV API (status: active)
Package rack-v2-BOKONTEPByteBeatMachine - wrong VCV API (status: active)
Package rack-v2-CaptainsSounds - util.h not found / wrong VCV API (status: active)
Package rack-v2-ChowDSP - wdf_t.h not found (status: active)
Package rack-v2-com-soundchasing-stochasm - wrong VCV API (status: active)
Package rack-v2-DelexanderVol1 - wrong VCV API (status: active)
Package rack-v2-ErraticInstruments - wrong VCV API (status: active)
Package rack-v2-Gratrix - wrong VCV API (status: active)
Package rack-v2-ILovePerlin - wrong VCV API (status: active)
Package rack-v2-ModularFungi - wrong VCV API (status: active)
Package rack-v2-Mog - wrong VCV API (status: active)
Package rack-v2-monome from - various compilation errors (status: active)
Package rack-v2-MpSeries from file ../rack/rack-v2/rack-v2-library-MpSeries.spec is missing (status: active)
Package rack-v2-mscHack - wrong VCV API (status: active)
Package rack-v2-mtsch-plugins - wrong VCV API (status: active)
Package rack-v2-MyLittleTools - wrong VCV API (status: active)
Package rack-v2-NauModular - wrong VCV API (status: active)
Package rack-v2-PG-Instruments - wrong VCV API (status: active)
Package rack-v2-PvC - wrong VCV API (status: active)
Package rack-v2-RacketScience - wrong VCV API (status: active)
Package rack-v2-ReTunesFree - wrong VCV API (status: active)
Package rack-v2-RJModules - wrong VCV API (status: active)
Package rack-v2-RODENTMODULES - wrong VCV API (status: active)
Package rack-v2-RPJVisualizer - projectM-4/projectM.h not found (status: active)
Package rack-v2-SerialRacker - wrong VCV API (status: active)
Package rack-v2-Southpole-parasites - wrong VCV API (status: active)
Package rack-v2-SubmarineFree - parameter not declared (status: active)
Package rack-v2-SubmarineUtility - wrong VCV API (status: active)
Package rack-v2-UnforgettableLuncheon - wrong VCV API (status: active)
Package rack-v2-WrongPeople - wrong VCV API (status: active)
