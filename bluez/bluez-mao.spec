...
%endif
           ...
           --enable-csip --enable-vcp --enable-midi \
...
%changelog
* Sun Dec 01 2024 Yann Collette <ycollette.nospam@free.fr> - 5.79-1
- Update to 5.79-1 - create a bluez-mao package enabling MIDI 
