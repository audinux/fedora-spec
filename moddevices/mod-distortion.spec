...
Release: 2%{?dist}
Summary: mod-distortion LV2 set of plugins from moddevices
License: GPL-2.0-or-later
URL: https://github.com/moddevices/mod-distortion
...
%description
mod-distortion LV2 set of plugins from moddevices
