...
Source0: https://github.com/davemollen/dm-TimeWarp/archive/%{commit0}.zip#/%{name}-%{version}.zip
...
cd lv2
cargo build --release
cp target/release/libdm_time_warp.so dm-TimeWarp.lv2/
cd ..

cd nih-plug
cargo xtask bundle dm_time_warp --release
...
cp -vfr dm_time_warp.clap %{buildroot}/%{_libdir}/clap/

install -m 755 -d %{buildroot}/%{_libdir}/vst3/
cp -vfr dm_time_warp.vst3 %{buildroot}/%{_libdir}/vst3/

cd ../../../lv2/
install -m 755 -d %{buildroot}/%{_libdir}/lv2/
cp -vfr dm-TimeWarp.lv2 %{buildroot}/%{_libdir}/lv2/
