...
%description
Sources for HOA3-plugins.

%package -n ladspa-hoa3-plugins
Summary: A collection of LADSPA plugins for third order Ambisonics

%description -n ladspa-hoa3-plugins
Hoa3-plugins is a collection of LADSPA plugins for
third order Ambisonics.

All plugins use the 'Ambix' format: SN3D gains and ACN
channel ordering, except where noted.
