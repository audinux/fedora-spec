...
const char *VersionInformation::git_tag{"v1.1.0"};
const char *VersionInformation::git_implied_display_version{"v1.1.0"};

const char *VersionInformation::project_version_major{"1"};
const char *VersionInformation::project_version_minor{"1"};
