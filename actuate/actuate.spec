...
%ifarch x86_64
rustup-init -y --no-modify-path --default-toolchain 1.86-x86_64-unknown-linux-gnu
%endif
%ifarch aarch64
rustup-init -y --no-modify-path --default-toolchain 1.86-aarch64-unknown-linux-gnu
%endif
source cargo/env
...
%changelog
* Wed Apr 15 2026 Yann Collette <ycollette.nospam@free.fr> - 1.4.5-1
- update to 1.4.5-1

* Sat Apr 11 2026 Yann Collette <ycollette.nospam@free.fr> - 1.4.4-1
- update to 1.4.4-1
...
* Mon Oct 13 2025 Yann Collette <ycollette.nospam@free.fr> - 1.4.1-1
- update to 1.4.1-1

* Fri Aug 22 2025 Yann Collette <ycollette.nospam@free.fr> - 1.4.0-1
- update to 1.4.0-1

* Sun May 25 2025 Yann Collette <ycollette.nospam@free.fr> - 1.3.91-1
- update to 1.3.91-1
