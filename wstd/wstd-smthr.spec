...
# ./wstd-source.sh wstd-smthr v1.0.1
...
cp -ra wstd_smthr/bin/WSTD_SMTHR.lv2 %{buildroot}/%{_libdir}/lv2/
cp wstd_smthr/bin/WSTD_SMTHR-vst.so %{buildroot}/%{_libdir}/vst/
cp -ra wstd_smthr/bin/WSTD_SMTHR.vst3 %{buildroot}/%{_libdir}/vst3/
cp wstd_smthr/bin/WSTD_SMTHR.clap %{buildroot}/%{_libdir}/clap/
