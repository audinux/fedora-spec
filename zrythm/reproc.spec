...
Source0: https://github.com/daandemeyer/reproc/archive/refs/tags/%{version}.tar.gz#/reproc-%{version}.tar.gz
...
%changelog
* Mon Aug 31 2026 Yann Collette <ycollette.nospam@free.fr> - 14.2.8-1
- update to 14.2.8-1
