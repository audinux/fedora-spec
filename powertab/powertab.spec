...
Source0: https://github.com/powertab/powertabeditor/archive/refs/tags/%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%changelog
* Sun Jun 29 2025 Yann Collette <ycollette.nospam@free.fr> - 2.0.22-4
- update to 2.0.22-4
