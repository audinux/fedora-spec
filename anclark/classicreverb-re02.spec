...
%description
Classic Reverb RE-02 is a reversed engineering of Kjaerhus Classic Reverb, a studio-quality free reverb plugin.
It is a variant of Classic Reverb RE-04. They have the same controls, but RE-02 has a different timbre.
RE-02 has enhanced features and a modern interface, while still retaining the charm of the original plugin.
...
Several DAWs like Acoustica Mixcraft included Classic Reverb as a built-in plugin, but it was only
available on Windows, and it only had a 32-bit VST2 version.
...
While Classic Reverb RE-02 has the same major features as its siblings (RE-04, RE-03), it has its own features:
- Wider and brighter sound image, with Less embrased sound field, which is similar to legendary plate reverb.
  This is much different from RE-04.
