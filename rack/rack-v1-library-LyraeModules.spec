...
%global commit0 29086f37cee1d24cae3574bc9e7df2434025b881
...
cp -n %{SOURCE2} LyraeModules_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/LyraeModules/
cp -r LyraeModules_plugin/dist/LyraeModules/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/LyraeModules/
