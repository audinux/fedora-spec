...
%global commit0 2f3a99155f3832464c17106e75c605a910608680
...
Name:    rack-v1-SunsetSignals
Version: 1.0.0
Release: 3%{?dist}
Summary: SunsetSignals plugin for Rack
License: GPL-2.0-or-later
URL:     https://gitlab.com/jeremy_mitchell/sunsetsignals
...
%description
SunsetSignals plugin for Rack.
Reads a signal in and boosts it
...
mkdir SunsetSignals_plugin
tar xvfz %{SOURCE1} --directory=SunsetSignals_plugin --strip-components=1 

cp -n %{SOURCE2} SunsetSignals_plugin/plugin.json || true

%build

cd SunsetSignals_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SunsetSignals/
cp -r SunsetSignals_plugin/dist/SunsetSignals/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SunsetSignals/
