...
%global commit0 2d479786cf4ccb8e2b39bd264efa2e8054b669d1
...
Version: 1.0.0
Release: 3%{?dist}
Summary: VO plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/evgazloy/VO
...
Source0: Rack.tar.gz
Source1: https://github.com/evgazloy/VO/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: VO_plugin.json
...
%description
VO plugin for Rack.
Control last touched parameter with midi map or cv
...
mkdir VO_plugin
tar xvfz %{SOURCE1} --directory=VO_plugin --strip-components=1

cp -n %{SOURCE2} VO_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/VO/
cp -r VO_plugin/dist/VO/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/VO/
