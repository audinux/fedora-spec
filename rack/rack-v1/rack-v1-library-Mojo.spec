...
%global commit0 01661b69929a8d99e0eb02afbd01828ce5dec750
...
%description
Mojo plugin for Rack.
A doggy drive effect
...
mkdir Mojo_plugin
tar xvfz %{SOURCE1} --directory=Mojo_plugin --strip-components=1

cp -n %{SOURCE2} Mojo_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Mojo/
cp -r Mojo_plugin/dist/Mojo/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Mojo/
