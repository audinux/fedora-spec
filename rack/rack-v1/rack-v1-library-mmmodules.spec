...
%description
mmmodules plugin for Rack.
Triple oscillator (mixer section coming soon)
...
mkdir mmmodules_plugin
tar xvfz %{SOURCE1} --directory=mmmodules_plugin --strip-components=1

cp -n %{SOURCE2} mmmodules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/mmmodules/
cp -r mmmodules_plugin/dist/mmmodules/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/mmmodules/
