...
cp -n %{SOURCE2} ReTunesFree_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ReTunesFree/
cp -r ReTunesFree_plugin/dist/ReTunesFree/* %{buildroot}%{_libexecdir}/Rack2/plugins/ReTunesFree/
