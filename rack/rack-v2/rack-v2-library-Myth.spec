...
%global commit0 937a105b481997532d302af19dedb8a8f1fe377b
...
Source0: Rack.tar.gz
Source1: https://github.com/Ahineya/vcv-myth-plugin/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Myth_plugin.json
...
mkdir Myth_plugin
tar xvfz %{SOURCE1} --directory=Myth_plugin --strip-components=1

cp -n %{SOURCE2} Myth_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Myth/
cp -r Myth_plugin/dist/Myth/* %{buildroot}%{_libexecdir}/Rack2/plugins/Myth/
