...
%global commit0 09d23864270f95ee75ef3df8213f57c814911827
...
Name: rack-v2-Volders
Version: 2.0.3
Release: 2%{?dist}
Summary: Volders plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/Acked-1/LFO-01
...
Source0: Rack.tar.gz
Source1: https://github.com/Acked-1/LFO-01/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Volders_plugin.json
...
%description
Volders plugin for Rack.
Low frequency oscillator with 4 selectable waveforms
...
mkdir Volders_plugin
tar xvfz %{SOURCE1} --directory=Volders_plugin --strip-components=1

cp -n %{SOURCE2} Volders_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Volders/
cp -r Volders_plugin/dist/Volders/* %{buildroot}%{_libexecdir}/Rack2/plugins/Volders/
