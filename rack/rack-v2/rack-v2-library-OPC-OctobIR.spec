...
%global commit0 996088e807020b18d412b3d4a0853b3a4900c866
...
Name: rack-v2-OPC-OctobIR
Version: 2.2.0
Release: 2%{?dist}
Summary: OPC-OctobIR plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/gianni-cappelletti/vcv-octobir
...
Source0: Rack.tar.gz
Source1: vcv-octobir.tar.gz
Source2: OPC-OctobIR_plugin.json
...
%description
OPC-OctobIR plugin for Rack.
Impulse response loader with static and dynamic blending options
...
mkdir OPC-OctobIR_plugin
tar xvfz %{SOURCE1} --directory=OPC-OctobIR_plugin --strip-components=1

cp -n %{SOURCE2} OPC-OctobIR_plugin/plugin.json || true

%build

cd OPC-OctobIR_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/OPC-OctobIR/
cp -r OPC-OctobIR_plugin/dist/OPC-OctobIR/* %{buildroot}%{_libexecdir}/Rack2/plugins/OPC-OctobIR/
