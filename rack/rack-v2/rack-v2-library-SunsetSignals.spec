...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SunsetSignals/
cp -r SunsetSignals_plugin/dist/SunsetSignals/* %{buildroot}%{_libexecdir}/Rack2/plugins/SunsetSignals/
