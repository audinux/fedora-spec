...
%global commit0 76d8a573b1e7b1f2fdfa45f7ec5ac89e7f55123d
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/QuantalAudio/
cp -r QuantalAudio_plugin/dist/QuantalAudio/* %{buildroot}%{_libexecdir}/Rack2/plugins/QuantalAudio/
