...
%global commit0 608ba60463d9132aab09dc1a681e676e742b4deb
...
cp -n %{SOURCE2} HamptonHarmonics_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/HamptonHarmonics/
cp -r HamptonHarmonics_plugin/dist/HamptonHarmonics/* %{buildroot}%{_libexecdir}/Rack2/plugins/HamptonHarmonics/
