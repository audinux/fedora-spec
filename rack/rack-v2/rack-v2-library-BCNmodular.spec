...
%global commit0 a91569319b703c42e8921a2a1c007a259c23b7c9
...
URL:     https://github.com/santifort-commits/BCNmodular
...
Source0: Rack.tar.gz
Source1: https://github.com/santifort-commits/BCNmodular/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: BCNmodular_plugin.json
...
mkdir BCNmodular_plugin
tar xvfz %{SOURCE1} --directory=BCNmodular_plugin --strip-components=1

cp -n %{SOURCE2} BCNmodular_plugin/plugin.json || true

%build

cd BCNmodular_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/BCNmodular/
cp -r BCNmodular_plugin/dist/BCNmodular/* %{buildroot}%{_libexecdir}/Rack2/plugins/BCNmodular/
