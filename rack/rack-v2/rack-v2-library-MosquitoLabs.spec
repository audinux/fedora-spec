...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MosquitoLabs/
cp -r MosquitoLabs_plugin/dist/MosquitoLabs/* %{buildroot}%{_libexecdir}/Rack2/plugins/MosquitoLabs/
