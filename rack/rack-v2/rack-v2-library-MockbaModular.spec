...
%global commit0 479d2c8007b2087cdf557a491df25c5b85784a96
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MockbaModular/
cp -r MockbaModular_plugin/dist/MockbaModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/MockbaModular/
