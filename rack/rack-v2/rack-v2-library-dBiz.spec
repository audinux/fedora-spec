...
%global commit0 ec7bcd9fecd21db4bb4a809b17ffaef7d5fb8125
%global gittag0 2.1
...
cp -n %{SOURCE2} dBiz_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/dBiz/
cp -r dBiz_plugin/dist/dBiz/* %{buildroot}%{_libexecdir}/Rack2/plugins/dBiz/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.1-1
- initial specfile
