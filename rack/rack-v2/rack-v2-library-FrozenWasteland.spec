...
%global commit0 0f261d59b0e06627743b12d1defe07fa59c931ab
...
cp -n %{SOURCE2} FrozenWasteland_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/FrozenWasteland/
cp -r FrozenWasteland_plugin/dist/FrozenWasteland/* %{buildroot}%{_libexecdir}/Rack2/plugins/FrozenWasteland/
