...
%global commit0 d6fd6efe9902d7dd928129c96eeb02e0fc66658c
%global gittag0 2.1.16
...
cp -n %{SOURCE2} computerscare_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/computerscare/
cp -r computerscare_plugin/dist/computerscare/* %{buildroot}%{_libexecdir}/Rack2/plugins/computerscare/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.1.16-1
- initial specfile
