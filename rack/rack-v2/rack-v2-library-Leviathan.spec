...
%global commit0 024b4b7c571a7b1ee046467981befadcf864983a
%global gittag0 2.3.12
...
URL:     https://github.com/PlasmaChroma/Leviathan-Rack2
...
Source0: Rack.tar.gz
Source1: https://github.com/PlasmaChroma/Leviathan-Rack2/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Leviathan_plugin.json
...
%description
Leviathan plugin for Rack.
Dual slope generator, variable curve slew, attenuverters, signal mixing, full audio-rate fidelity.
...
mkdir Leviathan_plugin
tar xvfz %{SOURCE1} --directory=Leviathan_plugin --strip-components=1

cp -n %{SOURCE2} Leviathan_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Leviathan/
cp -r Leviathan_plugin/dist/Leviathan/* %{buildroot}%{_libexecdir}/Rack2/plugins/Leviathan/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.3.12-1
- initial specfile
