...
%global commit0 b0f405f704ec4f2c1f3c65739c67aa7d62bcab79
...
Name:    rack-v2-SchlappiEngineering
Version: 2.0.0
Release: 2%{?dist}
Summary: SchlappiEngineering plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/SchlappiEngineering/Schlappi-vcv
...
Source0: Rack.tar.gz
Source1: https://github.com/SchlappiEngineering/Schlappi-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SchlappiEngineering_plugin.json
...
%description
SchlappiEngineering plugin for Rack.
...
mkdir SchlappiEngineering_plugin
tar xvfz %{SOURCE1} --directory=SchlappiEngineering_plugin --strip-components=1

cp -n %{SOURCE2} SchlappiEngineering_plugin/plugin.json || true

%build

cd SchlappiEngineering_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SchlappiEngineering/
cp -r SchlappiEngineering_plugin/dist/SchlappiEngineering/* %{buildroot}%{_libexecdir}/Rack2/plugins/SchlappiEngineering/
