...
%global commit0 0bee82247151e2fe2885f1e15fbbd74ddb4f48d0
...
cp -n %{SOURCE2} 21kHz_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/21kHz/
cp -r 21kHz_plugin/dist/21kHz/* %{buildroot}%{_libexecdir}/Rack2/plugins/21kHz/
