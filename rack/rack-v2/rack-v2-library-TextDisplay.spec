...
%global commit0 a7468df03e327f46120e2f89117a9897d525a78d
...
Name:    rack-v2-TextDisplay
Version: 2.0.0
Release: 2%{?dist}
Summary: TextDisplay plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/detnoise/TextDisplay
...
Source0: Rack.tar.gz
Source1: https://github.com/detnoise/TextDisplay/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: TextDisplay_plugin.json
...
%description
TextDisplay plugin for Rack.
Displays user-editable text vertically.
...
mkdir TextDisplay_plugin
tar xvfz %{SOURCE1} --directory=TextDisplay_plugin --strip-components=1

cp -n %{SOURCE2} TextDisplay_plugin/plugin.json || true

%build

cd TextDisplay_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/TextDisplay/
cp -r TextDisplay_plugin/dist/TextDisplay/* %{buildroot}%{_libexecdir}/Rack2/plugins/TextDisplay/
