...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/StudioSixPlusOne/
cp -r StudioSixPlusOne_plugin/dist/StudioSixPlusOne/* %{buildroot}%{_libexecdir}/Rack2/plugins/StudioSixPlusOne/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.3-1
- initial specfile
