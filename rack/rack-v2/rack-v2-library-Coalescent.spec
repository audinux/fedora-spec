...
%global commit0 63085f9ddf9d29398f2e773eaf53283b64fa318c
...
URL:     https://github.com/jeremycg/coalescent
...
Source0: Rack.tar.gz
Source1: https://github.com/jeremycg/coalescent/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Coalescent_plugin.json
...
%description
Coalescent plugin for Rack.
Dynamic stochastic synthesis oscillator based on Xenakis GENDY3
...
mkdir Coalescent_plugin
tar xvfz %{SOURCE1} --directory=Coalescent_plugin --strip-components=1

cp -n %{SOURCE2} Coalescent_plugin/plugin.json || true

%build

cd Coalescent_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Coalescent/
cp -r Coalescent_plugin/dist/Coalescent/* %{buildroot}%{_libexecdir}/Rack2/plugins/Coalescent/
