...
Name:    rack-v2-BeckstromResearch
Version: 0.6.0
Release: 1%{?dist}
...
cp -n %{SOURCE2} BeckstromResearch_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/BeckstromResearch/
cp -r BeckstromResearch_plugin/dist/BeckstromResearch/* %{buildroot}%{_libexecdir}/Rack2/plugins/BeckstromResearch/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 0.6.0-1
- initial specfile
