...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/FehlerFabrik-Suite/
cp -r FehlerFabrik-Suite_plugin/dist/FehlerFabrik-Suite/* %{buildroot}%{_libexecdir}/Rack2/plugins/FehlerFabrik-Suite/
