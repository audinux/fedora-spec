...
%global commit0 faee0202cd8198c48cd0d2eb1c97d829c86e6d7f
...
Version: 2.0.0
Release: 2%{?dist}
Summary: Keeos plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/keeos-io/ogham-vcv
...
Source0: Rack.tar.gz
Source1: https://github.com/keeos-io/ogham-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Keeos_plugin.json
...
%description
Keeos plugin for Rack.
Dual-voice bytebeat synthesizer. A port of the Keeos Ogham Eurorack module, running the module's own DSP.
...
mkdir Keeos_plugin
tar xvfz %{SOURCE1} --directory=Keeos_plugin --strip-components=1

cp -n %{SOURCE2} Keeos_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Keeos/
cp -r Keeos_plugin/dist/Keeos/* %{buildroot}%{_libexecdir}/Rack2/plugins/Keeos/
