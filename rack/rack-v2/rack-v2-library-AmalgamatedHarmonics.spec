...
%global commit0 bf74c2b7674c610cfc57421157d814c98bd92438
...
cp -n %{SOURCE2} AmalgamatedHarmonics_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AmalgamatedHarmonics/
cp -r AmalgamatedHarmonics_plugin/dist/AmalgamatedHarmonics/* %{buildroot}%{_libexecdir}/Rack2/plugins/AmalgamatedHarmonics/
