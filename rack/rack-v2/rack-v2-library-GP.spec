...
%global commit0 9068e02e7dcd43cf018c6b6b851691f53e928b88
...
Version: 2.1.0
Release: 2%{?dist}
Summary: GP plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/GPrackmodules/GPrackmodules
...
Source0: Rack.tar.gz
Source1: https://github.com/GPrackmodules/GPrackmodules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: GP_plugin.json
...
%description
GP plugin for Rack.
4 Channel A/B Switcher for audio and CV
...
mkdir GP_plugin
tar xvfz %{SOURCE1} --directory=GP_plugin --strip-components=1

cp -n %{SOURCE2} GP_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/GP/
cp -r GP_plugin/dist/GP/* %{buildroot}%{_libexecdir}/Rack2/plugins/GP/
