...
cp -n %{SOURCE2} Koralfx-Modules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Koralfx-Modules/
cp -r Koralfx-Modules_plugin/dist/Koralfx-Modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/Koralfx-Modules/
