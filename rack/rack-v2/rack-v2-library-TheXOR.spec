...
cp -n %{SOURCE2} TheXOR_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/TheXOR/
cp -r TheXOR_plugin/dist/TheXOR/* %{buildroot}%{_libexecdir}/Rack2/plugins/TheXOR/
