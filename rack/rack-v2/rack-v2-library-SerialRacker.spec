...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SerialRacker/
cp -r SerialRacker_plugin/dist/SerialRacker/* %{buildroot}%{_libexecdir}/Rack2/plugins/SerialRacker/
