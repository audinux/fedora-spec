...
cp -n %{SOURCE2} CatroBlanco_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CatroBlanco/
cp -r CatroBlanco_plugin/dist/CatroBlanco/* %{buildroot}%{_libexecdir}/Rack2/plugins/CatroBlanco/
