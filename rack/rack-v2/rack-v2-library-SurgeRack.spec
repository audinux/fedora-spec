...
%global commit0 fb9c9a2f58e3a4c3c35c7339cb6116efa72347fa
%global gittag0 2.1.7.0
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SurgeRack/
cp -r SurgeRack_plugin/dist/SurgeRack/* %{buildroot}%{_libexecdir}/Rack2/plugins/SurgeRack/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.1.7.0-1
- initial specfile
