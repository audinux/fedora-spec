...
%global commit0 e04dd795ea8d9f08e82a0ca1457fcb9ad59c00ed
...
cp -n %{SOURCE2} DrumKit_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/DrumKit/
cp -r DrumKit_plugin/dist/DrumKit/* %{buildroot}%{_libexecdir}/Rack2/plugins/DrumKit/
