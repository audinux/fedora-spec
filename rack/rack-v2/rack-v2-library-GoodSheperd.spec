...
%global commit0 636351059f2eec629f3b8a537451dd3d0eb01c30
...
cp -n %{SOURCE2} GoodSheperd_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/GoodSheperd/
cp -r GoodSheperd_plugin/dist/GoodSheperd/* %{buildroot}%{_libexecdir}/Rack2/plugins/GoodSheperd/
