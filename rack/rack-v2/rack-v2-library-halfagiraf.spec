...
%global commit0 3541f29430eeca862c3f68d0306fe6c75f43f083
...
Name: rack-v2-halfagiraf
Version: 2.0.2
Release: 2%{?dist}
Summary: halfagiraf plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/stevenmcsorley/halfagiraf-modules
...
Source0: Rack.tar.gz
Source1: https://github.com/stevenmcsorley/halfagiraf-modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: halfagiraf_plugin.json
...
%description
halfagiraf plugin for Rack.
Stereo buffer-corruption and broken-playback processor.
...
mkdir halfagiraf_plugin
tar xvfz %{SOURCE1} --directory=halfagiraf_plugin --strip-components=1

cp -n %{SOURCE2} halfagiraf_plugin/plugin.json || true

%build

cd halfagiraf_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/halfagiraf/
cp -r halfagiraf_plugin/dist/halfagiraf/* %{buildroot}%{_libexecdir}/Rack2/plugins/halfagiraf/
