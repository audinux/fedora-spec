...
%global commit0 8630af74d4aed840b5251c8526612a043a6d14bb
...
URL: https://github.com/akaudio-dev/akaudio
...
Source0: Rack.tar.gz
Source1: https://github.com/akaudio-dev/akaudio/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: akaudio_plugin.json
...
mkdir akaudio_plugin
tar xvfz %{SOURCE1} --directory=akaudio_plugin --strip-components=1

cp -n %{SOURCE2} akaudio_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/akaudio/
cp -r akaudio_plugin/dist/akaudio/* %{buildroot}%{_libexecdir}/Rack2/plugins/akaudio/
