...
%global commit0 8f50bfa599a06aa161d2a4b621e606022ccf5c16
...
Name: rack-v2-ForgeAudio-AnalogSeries
Version: 2.0.1
Release: 2%{?dist}
Summary: ForgeAudio-AnalogSeries plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/Photep/ForgeAudio-AnalogSeries
...
Source0: Rack.tar.gz
Source1: https://github.com/Photep/ForgeAudio-AnalogSeries/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: ForgeAudio-AnalogSeries_plugin.json
...
%description
ForgeAudio-AnalogSeries plugin for Rack.
...
mkdir ForgeAudio-AnalogSeries_plugin
tar xvfz %{SOURCE1} --directory=ForgeAudio-AnalogSeries_plugin --strip-components=1

cp -n %{SOURCE2} ForgeAudio-AnalogSeries_plugin/plugin.json || true

%build

cd ForgeAudio-AnalogSeries_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ForgeAudio-AnalogSeries/
cp -r ForgeAudio-AnalogSeries_plugin/dist/ForgeAudio-AnalogSeries/* %{buildroot}%{_libexecdir}/Rack2/plugins/ForgeAudio-AnalogSeries/
