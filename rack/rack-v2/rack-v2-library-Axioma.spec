...
cp -n %{SOURCE2} Axioma_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Axioma/
cp -r Axioma_plugin/dist/Axioma/* %{buildroot}%{_libexecdir}/Rack2/plugins/Axioma/
