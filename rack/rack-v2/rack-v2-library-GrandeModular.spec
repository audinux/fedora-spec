...
%global commit0 718a4ff208e4ac114a1efb7123b6e84ca3f9ba6a
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/GrandeModular/
cp -r GrandeModular_plugin/dist/GrandeModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/GrandeModular/
