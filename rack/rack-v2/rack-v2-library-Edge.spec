...
cp -n %{SOURCE2} Edge_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Edge/
cp -r Edge_plugin/dist/Edge/* %{buildroot}%{_libexecdir}/Rack2/plugins/Edge/
