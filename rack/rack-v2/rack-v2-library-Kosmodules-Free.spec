...
cp -n %{SOURCE2} Kosmodules-Free_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Kosmodules-Free/
cp -r Kosmodules-Free_plugin/dist/Kosmodules-Free/* %{buildroot}%{_libexecdir}/Rack2/plugins/Kosmodules-Free/
