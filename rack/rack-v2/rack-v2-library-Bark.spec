...
Patch1: rack-v2-library-Bark-aarch64.patch
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Bark/
cp -r Bark_plugin/dist/Bark/* %{buildroot}%{_libexecdir}/Rack2/plugins/Bark/
