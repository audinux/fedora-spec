...
%global commit0 1fd26f2f27a2077868a9c78582efb5c650bd1519
...
cp -n %{SOURCE2} Geodesics_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Geodesics/
cp -r Geodesics_plugin/dist/Geodesics/* %{buildroot}%{_libexecdir}/Rack2/plugins/Geodesics/
