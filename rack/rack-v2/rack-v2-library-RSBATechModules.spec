...
%global commit0 3ec0a927954454f62dfca5a52616a904f47c52bf
...
URL:     https://github.com/rjsmith/rsbatech-modules
...
Source0: Rack.tar.gz
Source1: https://github.com/rjsmith/rsbatech-modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: RSBATechModules_plugin.json
...
%description
RSBATechModules plugin for Rack.
Module control from Electra One Controller
...
mkdir RSBATechModules_plugin
tar xvfz %{SOURCE1} --directory=RSBATechModules_plugin --strip-components=1

cp -n %{SOURCE2} RSBATechModules_plugin/plugin.json || true

%build

cd RSBATechModules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RSBATechModules/
cp -r RSBATechModules_plugin/dist/RSBATechModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/RSBATechModules/
