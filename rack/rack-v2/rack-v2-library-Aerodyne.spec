...
%global commit0 6a42d08cf8389e85f4155387f09371cd4a9dafe6
...
Name: rack-v2-Aerodyne
Version: 2.0.0
Release: 2%{?dist}
Summary: Aerodyne plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/gfy20070704-stack/Aerodyne-IdmGlitchNode
...
Source0: Rack.tar.gz
Source1: https://github.com/gfy20070704-stack/Aerodyne-IdmGlitchNode/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Aerodyne_plugin.json
...
%description
Aerodyne plugin for Rack.
Shift-register glitch node with mutation probability, CV and gate outputs.
...
mkdir Aerodyne_plugin
tar xvfz %{SOURCE1} --directory=Aerodyne_plugin --strip-components=1

cp -n %{SOURCE2} Aerodyne_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Aerodyne/
cp -r Aerodyne_plugin/dist/Aerodyne/* %{buildroot}%{_libexecdir}/Rack2/plugins/Aerodyne/
