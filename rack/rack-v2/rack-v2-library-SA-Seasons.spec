...
cp -n %{SOURCE2} SA-Seasons_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SA-Seasons/
cp -r SA-Seasons_plugin/dist/SA-Seasons/* %{buildroot}%{_libexecdir}/Rack2/plugins/SA-Seasons/
