...
%global commit0 f68902c531866c090234fd77ec51ff3b15eec26d
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SonusModular/
cp -r SonusModular_plugin/dist/SonusModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/SonusModular/
