...
%global commit0 80422acf5a0cf5d4e8f14298e7f41ff8fab39543
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CatroModulo/
cp -r CatroModulo_plugin/dist/CatroModulo/* %{buildroot}%{_libexecdir}/Rack2/plugins/CatroModulo/
