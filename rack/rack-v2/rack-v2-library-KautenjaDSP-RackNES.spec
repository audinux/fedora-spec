...
%global commit0 f4271500cadbcb1258bd9e47ac2a7a822e0fde90
...
Name:    rack-v2-KautenjaDSP-RackNES
Version: 2.0.0
Release: 1%{?dist}
...
cp -n %{SOURCE2} KautenjaDSP-RackNES_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/KautenjaDSP-RackNES/
cp -r KautenjaDSP-RackNES_plugin/dist/KautenjaDSP-RackNES/* %{buildroot}%{_libexecdir}/Rack2/plugins/KautenjaDSP-RackNES/
