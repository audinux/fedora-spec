...
URL:     https://github.com/thement/camouflage
...
Source0: Rack.tar.gz
Source1: https://github.com/thement/camouflage/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: camouflage_plugin.json
...
mkdir camouflage_plugin
tar xvfz %{SOURCE1} --directory=camouflage_plugin --strip-components=1

cp -n %{SOURCE2} camouflage_plugin/plugin.json || true

%build

cd camouflage_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/camouflage/
cp -r camouflage_plugin/dist/camouflage/* %{buildroot}%{_libexecdir}/Rack2/plugins/camouflage/
