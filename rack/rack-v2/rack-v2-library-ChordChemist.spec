...
URL:     https://github.com/TheDrude/ChordChemist
...
Source0: Rack.tar.gz
Source1: https://github.com/TheDrude/ChordChemist/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: ChordChemist_plugin.json
...
%description
ChordChemist plugin for Rack.
Circular Chord Generative Sequencer
...
mkdir ChordChemist_plugin
tar xvfz %{SOURCE1} --directory=ChordChemist_plugin --strip-components=1

cp -n %{SOURCE2} ChordChemist_plugin/plugin.json || true

%build

cd ChordChemist_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ChordChemist/
cp -r ChordChemist_plugin/dist/ChordChemist/* %{buildroot}%{_libexecdir}/Rack2/plugins/ChordChemist/
