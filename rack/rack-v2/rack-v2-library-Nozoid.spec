...
%global commit0 97cefe3c98d01060446395d4e18f11c4028bb4d4
...
cp -n %{SOURCE2} Nozoid_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Nozoid/
cp -r Nozoid_plugin/dist/Nozoid/* %{buildroot}%{_libexecdir}/Rack2/plugins/Nozoid/
