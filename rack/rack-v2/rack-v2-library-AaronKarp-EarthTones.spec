...
URL:     https://github.com/aaronkarp123/EarthTones
...
Source0: Rack.tar.gz
Source1: https://github.com/aaronkarp123/EarthTones/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AaronKarp-EarthTones_plugin.json
...
%description
AaronKarp-EarthTones plugin for Rack.
...
mkdir AaronKarp-EarthTones_plugin
tar xvfz %{SOURCE1} --directory=AaronKarp-EarthTones_plugin --strip-components=1

cp -n %{SOURCE2} AaronKarp-EarthTones_plugin/plugin.json || true

%build

cd AaronKarp-EarthTones_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AaronKarp-EarthTones/
cp -r AaronKarp-EarthTones_plugin/dist/AaronKarp-EarthTones/* %{buildroot}%{_libexecdir}/Rack2/plugins/AaronKarp-EarthTones/
