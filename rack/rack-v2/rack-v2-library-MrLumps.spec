...
%global commit0 479658080d796a48b8993912cf2ed0fc534c3631
...
cp -n %{SOURCE2} MrLumps_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MrLumps/
cp -r MrLumps_plugin/dist/MrLumps/* %{buildroot}%{_libexecdir}/Rack2/plugins/MrLumps/
