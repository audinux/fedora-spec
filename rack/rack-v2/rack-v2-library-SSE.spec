...
URL:     https://github.com/herbert-50/SSE-One/
...
Source0: Rack.tar.gz
Source1: https://github.com/herbert-50/SSE-One/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SSE_plugin.json
...
mkdir SSE_plugin
tar xvfz %{SOURCE1} --directory=SSE_plugin --strip-components=1

cp -n %{SOURCE2} SSE_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SSE/
cp -r SSE_plugin/dist/SSE/* %{buildroot}%{_libexecdir}/Rack2/plugins/SSE/
