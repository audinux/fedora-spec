...
%global commit0 a15554e33721c2f8f65bb6b0f59588307fb6e625
...
Name:    rack-v2-AudibleInstruments
Version: 2.0.0
Release: 1%{?dist}
...
cp -n %{SOURCE2} AudibleInstruments_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AudibleInstruments/
cp -r AudibleInstruments_plugin/dist/AudibleInstruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/AudibleInstruments/
