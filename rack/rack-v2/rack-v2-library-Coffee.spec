...
%global commit0 dfb2174d7f8cd4b035abd1aac2555f941a517854
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Coffee/
cp -r Coffee_plugin/dist/Coffee/* %{buildroot}%{_libexecdir}/Rack2/plugins/Coffee/
