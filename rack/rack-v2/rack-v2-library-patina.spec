...
%global commit0 6f4afdf83bc065461391ce524d0fc6507180be1f
...
Source0: Rack.tar.gz
Source1: https://github.com/epadilla/patina/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: patina_plugin.json
...
mkdir patina_plugin
tar xvfz %{SOURCE1} --directory=patina_plugin --strip-components=1 

cp -n %{SOURCE2} patina_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/patina/
cp -r patina_plugin/dist/patina/* %{buildroot}%{_libexecdir}/Rack2/plugins/patina/
