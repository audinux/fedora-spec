...
%global commit0 f8a00722b97c97dd2490a7f9e7dc3f24f488a9aa
...
Version: 2.0.1
Release: 1%{?dist}
Summary: ASK plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/pawal/ask-vcv-modules
...
Source0: Rack.tar.gz
Source1: https://github.com/pawal/ask-vcv-modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: ASK_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ASK/
cp -r ASK_plugin/dist/ASK/* %{buildroot}%{_libexecdir}/Rack2/plugins/ASK/
