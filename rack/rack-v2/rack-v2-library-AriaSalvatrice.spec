...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AriaSalvatrice/
cp -r AriaSalvatrice_plugin/dist/AriaSalvatrice/* %{buildroot}%{_libexecdir}/Rack2/plugins/AriaSalvatrice/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.8.1-1
- initial specfile
