...
cp -n %{SOURCE2} CYC_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CYC/
cp -r CYC_plugin/dist/CYC/* %{buildroot}%{_libexecdir}/Rack2/plugins/CYC/
