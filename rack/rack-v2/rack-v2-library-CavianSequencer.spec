...
%global commit0 7c47b01c7a5cbc9e47d68b7119f1b2ba0e618b7d
...
Name:    rack-v2-CavianSequencer
Version: 2.0.0
Release: 2%{?dist}
Summary: CavianSequencer plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/nikscave/Cavian-VCV
...
Source0: Rack.tar.gz
Source1: https://github.com/nikscave/Cavian-VCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: CavianSequencer_plugin.json
...
%description
CavianSequencer plugin for Rack.
8-channel multi-step sequencer and a lot more, save locally, loop, copy paste, clear, randomise
...
mkdir CavianSequencer_plugin
tar xvfz %{SOURCE1} --directory=CavianSequencer_plugin --strip-components=1

cp -n %{SOURCE2} CavianSequencer_plugin/plugin.json || true

%build

cd CavianSequencer_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CavianSequencer/
cp -r CavianSequencer_plugin/dist/CavianSequencer/* %{buildroot}%{_libexecdir}/Rack2/plugins/CavianSequencer/
