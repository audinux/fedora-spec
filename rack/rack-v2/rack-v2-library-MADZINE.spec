...
%global commit0 c294c1a20e9ed2116943d30b61a9bf02da3b7684
...
URL:     https://github.com/mmmmmmmadman/MADZINE-VCV
...
%description
MADZINE plugin for Rack.
A dual-waveform LFO with swing and shape control
...
mkdir MADZINE_plugin
tar xvfz %{SOURCE1} --directory=MADZINE_plugin --strip-components=1

cp -n %{SOURCE2} MADZINE_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MADZINE/
cp -r MADZINE_plugin/dist/MADZINE/* %{buildroot}%{_libexecdir}/Rack2/plugins/MADZINE/
