...
%global commit0 5c6f38d55f4c2cf831193055f6011ed3ce645fa9
...
Name:    rack-v2-FartSynthson
Version: 2.0.0
Release: 2%{?dist}
Summary: FartSynthson plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/Cumbiambero/fart-synthson
...
Source0: Rack.tar.gz
Source1: https://github.com/Cumbiambero/fart-synthson/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: FartSynthson_plugin.json
...
%description
FartSynthson plugin for Rack.
You don't have to spend a fortune on hardware modules if you just want to produce that kind of sound.
...
mkdir FartSynthson_plugin
tar xvfz %{SOURCE1} --directory=FartSynthson_plugin --strip-components=1

cp -n %{SOURCE2} FartSynthson_plugin/plugin.json || true

%build

cd FartSynthson_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/FartSynthson/
cp -r FartSynthson_plugin/dist/FartSynthson/* %{buildroot}%{_libexecdir}/Rack2/plugins/FartSynthson/
