...
Name:    rack-v2-ParableInstruments
Version: 1.0.0
Release: 1%{?dist}
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ParableInstruments/
cp -r ParableInstruments_plugin/dist/ParableInstruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/ParableInstruments/
