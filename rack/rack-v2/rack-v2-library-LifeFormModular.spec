...
cp -n %{SOURCE2} LifeFormModular_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LifeFormModular/
cp -r LifeFormModular_plugin/dist/LifeFormModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/LifeFormModular/
