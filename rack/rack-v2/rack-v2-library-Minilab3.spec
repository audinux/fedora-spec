...
URL:     https://github.com/dustinlacewell/vcv-minilab3
...
Source0: Rack.tar.gz
Source1: https://github.com/dustinlacewell/vcv-minilab3/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Minilab3_plugin.json
...
%description
Minilab3 plugin for Rack.
Multiplex MIDI signals through expander modules.
...
mkdir Minilab3_plugin
tar xvfz %{SOURCE1} --directory=Minilab3_plugin --strip-components=1

cp -n %{SOURCE2} Minilab3_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Minilab3/
cp -r Minilab3_plugin/dist/Minilab3/* %{buildroot}%{_libexecdir}/Rack2/plugins/Minilab3/
