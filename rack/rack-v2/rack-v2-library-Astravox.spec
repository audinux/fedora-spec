...
%global commit0 c9b8c746ad3d87a67261e6cadc8f89e5ce6c7c72
...
Name: rack-v2-Astravox
Version: 2.0.3
Release: 2%{?dist}
Summary: Astravox plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/JackArkyDev/Astravox
...
Source0: Rack.tar.gz
Source1: https://github.com/JackArkyDev/Astravox/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Astravox_plugin.json
...
%description
Astravox plugin for Rack.
16-band vocoder with per-band level faders, internal carrier oscillator, and spectral CV outputs
...
mkdir Astravox_plugin
tar xvfz %{SOURCE1} --directory=Astravox_plugin --strip-components=1

cp -n %{SOURCE2} Astravox_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Astravox/
cp -r Astravox_plugin/dist/Astravox/* %{buildroot}%{_libexecdir}/Rack2/plugins/Astravox/
