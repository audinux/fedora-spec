...
%global commit0 8a38d025030a2f2a7bafb1b9fd81a1b4e1e2cee9
...
Name:    rack-v2-CuteFoxModules
Version: 2.0.1
Release: 2%{?dist}
Summary: CuteFoxModules plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/CuteFoxModules/CuteFoxModules
...
Source0: Rack.tar.gz
Source1: https://github.com/CuteFoxModules/CuteFoxModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: CuteFoxModules_plugin.json
...
%description
CuteFoxModules plugin for Rack.
...
mkdir CuteFoxModules_plugin
tar xvfz %{SOURCE1} --directory=CuteFoxModules_plugin --strip-components=1

cp -n %{SOURCE2} CuteFoxModules_plugin/plugin.json || true

%build

cd CuteFoxModules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CuteFoxModules/
cp -r CuteFoxModules_plugin/dist/CuteFoxModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/CuteFoxModules/
