...
cp -n %{SOURCE2} LomasModules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LomasModules/
cp -r LomasModules_plugin/dist/LomasModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/LomasModules/
