...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/PG-Instruments/
cp -r PG-Instruments_plugin/dist/PG-Instruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/PG-Instruments/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 0.6.4-1
- initial specfile
