...
cp -n %{SOURCE2} NauModular_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NauModular/
cp -r NauModular_plugin/dist/NauModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/NauModular/
