...
%global commit0 ea6ab0c6887102ebbf6e3534e0e891b867b130cc
...
Source0: Rack.tar.gz
Source1: https://github.com/VegaDeftwing/PinkTromboneVCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: PinkTrombone_plugin.json
...
cd PinkTrombone_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/PinkTrombone/
cp -r PinkTrombone_plugin/dist/PinkTrombone/* %{buildroot}%{_libexecdir}/Rack2/plugins/PinkTrombone/
