...
%global commit0 17498ab003459bd54c6feb0e5be5eafb21e62bb3
...
Name:    rack-v2-DelexanderVol1
Version: 1.0.2
Release: 1%{?dist}
Summary: DelexanderVol1 plugin for Rack
License: GPLv2+
URL:     https://github.com/Delexander/Volume1
...
Source0: Rack.tar.gz
Source1: https://github.com/Delexander/Volume1/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: DelexanderVol1_plugin.json
...
%description
DelexanderVol1 plugin for Rack.
4-Channel Multistate Router with Morphing and Graph Visualization
...
cd DelexanderVol1_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/DelexanderVol1/
cp -r DelexanderVol1_plugin/dist/DelexanderVol1/* %{buildroot}%{_libexecdir}/Rack2/plugins/DelexanderVol1/
