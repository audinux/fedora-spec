...
%global commit0 1fc62fafe66bd622432db895a09ef1e3afc4531c
...
cp -n %{SOURCE2} LOGinstruments_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LOGinstruments/
cp -r LOGinstruments_plugin/dist/LOGinstruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/LOGinstruments/
