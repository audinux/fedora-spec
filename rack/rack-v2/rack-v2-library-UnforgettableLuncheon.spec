...
Name:    rack-v2-UnforgettableLuncheon
Version: 0.6.3
Release: 1%{?dist}
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/UnforgettableLuncheon/
cp -r UnforgettableLuncheon_plugin/dist/UnforgettableLuncheon/* %{buildroot}%{_libexecdir}/Rack2/plugins/UnforgettableLuncheon/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 0.6.3-1
- initial specfile
