...
%global commit0 3fd1b893336c17e790ecc745aeb67151e8fabc45
...
Name:    rack-v2-dbRackFormulaOne
Version: 2.0.0
Release: 1%{?dist}
Summary: dbRackFormulaOne plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/docb/dbRackFormulaOne
...
Source0: Rack.tar.gz
Source1: https://github.com/docb/dbRackFormulaOne/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: dbRackFormulaOne_plugin.json
...
%description
dbRackFormulaOne plugin for Rack.
...
mkdir dbRackFormulaOne_plugin
tar xvfz %{SOURCE1} --directory=dbRackFormulaOne_plugin --strip-components=1

cp -n %{SOURCE2} dbRackFormulaOne_plugin/plugin.json || true

%build

cd dbRackFormulaOne_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/dbRackFormulaOne/
cp -r dbRackFormulaOne_plugin/dist/dbRackFormulaOne/* %{buildroot}%{_libexecdir}/Rack2/plugins/dbRackFormulaOne/
