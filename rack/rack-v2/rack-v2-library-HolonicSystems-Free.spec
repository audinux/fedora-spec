...
%global commit0 5fe1d9b68bb1fb8205308cd41a0be3ea1a019299
...
Name:    rack-v2-HolonicSystems-Free
Version: 2.0.7
Release: 1%{?dist}
...
cp -n %{SOURCE2} HolonicSystems-Free_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/HolonicSystems-Free/
cp -r HolonicSystems-Free_plugin/dist/HolonicSystems-Free/* %{buildroot}%{_libexecdir}/Rack2/plugins/HolonicSystems-Free/
