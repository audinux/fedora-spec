...
%global commit0 912968c3593fb5ed71c462b4858fc4d36ea05dd4
...
%description
TeknoLogical plugin for Rack.
Compact 5-voice rhythm engine.
...
mkdir TeknoLogical_plugin
tar xvfz %{SOURCE1} --directory=TeknoLogical_plugin --strip-components=1

cp -n %{SOURCE2} TeknoLogical_plugin/plugin.json || true

%build

cd TeknoLogical_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/TeknoLogical/
cp -r TeknoLogical_plugin/dist/TeknoLogical/* %{buildroot}%{_libexecdir}/Rack2/plugins/TeknoLogical/
