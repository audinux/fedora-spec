...
%global commit0 f037bcab20d92f4734437a1aad877499e7d1fe46
...
cp -n %{SOURCE2} cf_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/cf/
cp -r cf_plugin/dist/cf/* %{buildroot}%{_libexecdir}/Rack2/plugins/cf/
