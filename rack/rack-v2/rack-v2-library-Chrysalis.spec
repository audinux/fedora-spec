...
%global commit0 8f15282c4357b25a4fea0127057c6dfff8953f2a
...
Source0: Rack.tar.gz
Source1: Chrysalis.tar.gz
Source2: Chrysalis_plugin.json
...
%description
Chrysalis plugin for Rack.
ChucK Programming Language Module
...
mkdir Chrysalis_plugin
tar xvfz %{SOURCE1} --directory=Chrysalis_plugin --strip-components=1

cp -n %{SOURCE2} Chrysalis_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Chrysalis/
cp -r Chrysalis_plugin/dist/Chrysalis/* %{buildroot}%{_libexecdir}/Rack2/plugins/Chrysalis/
