...
%global commit0 9d39087734fc7374f7a90165e9b700c19983c940
%global gittag0 2.6.10
...
Source0: Rack.tar.gz
Source1: https://github.com/sickozell/SickoCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SickoCV_plugin.json
...
mkdir SickoCV_plugin
tar xvfz %{SOURCE1} --directory=SickoCV_plugin --strip-components=1

cp -n %{SOURCE2} SickoCV_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SickoCV/
cp -r SickoCV_plugin/dist/SickoCV/* %{buildroot}%{_libexecdir}/Rack2/plugins/SickoCV/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.6.10-1
- initial specfile
