...
%global commit0 7bf6729582447261ff578567560eb00bde5deae6
...
8 buffered toggle switches (flip flop) with gate output and signal routing
...
cp -n %{SOURCE2} SickoCV_plugin/plugin.json
