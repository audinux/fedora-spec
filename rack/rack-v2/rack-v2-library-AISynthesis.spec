...
%global commit0 f974aa9499069d56d96245f129bf99bd8114d962
...
Name:    rack-v2-AISynthesis
Version: 2.0.1
Release: 2%{?dist}
Summary: AISynthesis plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/AIsynthesis/vcvrack
...
Source0: Rack.tar.gz
Source1: https://github.com/AIsynthesis/vcvrack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AISynthesis_plugin.json
...
%description
AISynthesis plugin for Rack.
2HP passive multiple — 8 jacks in two switchable groups
...
mkdir AISynthesis_plugin
tar xvfz %{SOURCE1} --directory=AISynthesis_plugin --strip-components=1

cp -n %{SOURCE2} AISynthesis_plugin/plugin.json || true

%build

cd AISynthesis_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AISynthesis/
cp -r AISynthesis_plugin/dist/AISynthesis/* %{buildroot}%{_libexecdir}/Rack2/plugins/AISynthesis/
