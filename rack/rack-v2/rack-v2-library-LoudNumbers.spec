...
%global commit0 351d3714d82d1b12d40ca443115b7598450cb853
...
Source0: Rack.tar.gz
Source1: https://github.com/loudnumbers/loudnumbers_vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: LoudNumbers_plugin.json
...
mkdir LoudNumbers_plugin
tar xvfz %{SOURCE1} --directory=LoudNumbers_plugin --strip-components=1

cp -n %{SOURCE2} LoudNumbers_plugin/plugin.json || true

%build

cd LoudNumbers_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LoudNumbers/
cp -r LoudNumbers_plugin/dist/LoudNumbers/* %{buildroot}%{_libexecdir}/Rack2/plugins/LoudNumbers/
