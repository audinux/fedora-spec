...
%global commit0 7d1aaef1234df51278c9147802d4d84952431073
...
cp -n %{SOURCE2} ODDSound_MTS_ESP_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ODDSound_MTS_ESP/
cp -r ODDSound_MTS_ESP_plugin/dist/ODDSound_MTS_ESP/* %{buildroot}%{_libexecdir}/Rack2/plugins/ODDSound_MTS_ESP/
