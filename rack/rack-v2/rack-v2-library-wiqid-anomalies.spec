...
%global commit0 7dd0a1292b101542c11aa179142593474db7127d
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/wiqid-anomalies/
cp -r wiqid-anomalies_plugin/dist/wiqid-anomalies/* %{buildroot}%{_libexecdir}/Rack2/plugins/wiqid-anomalies/
