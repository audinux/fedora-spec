...
URL:     https://github.com/boocup/PhrasingModule
...
Source0: Rack.tar.gz
Source1: https://github.com/boocup/PhrasingModule/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: phrasing-module_plugin.json
...
%description
phrasing-module plugin for Rack.
...
mkdir phrasing-module_plugin
tar xvfz %{SOURCE1} --directory=phrasing-module_plugin --strip-components=1

cp -n %{SOURCE2} phrasing-module_plugin/plugin.json || true

%build

cd phrasing-module_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/phrasing-module/
cp -r phrasing-module_plugin/dist/phrasing-module/* %{buildroot}%{_libexecdir}/Rack2/plugins/phrasing-module/
