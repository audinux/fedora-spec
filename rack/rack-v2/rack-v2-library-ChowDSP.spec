...
%global commit0 e1a20acc0fe64ed42d7a91ddcdbdf12daa6ec6d3
...
cp -n %{SOURCE2} ChowDSP_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ChowDSP/
cp -r ChowDSP_plugin/dist/ChowDSP/* %{buildroot}%{_libexecdir}/Rack2/plugins/ChowDSP/
