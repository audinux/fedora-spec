...
%global commit0 81c5b530bb39a9405714a974ac5d07241e303d18
...
cp -n %{SOURCE2} OSCelot_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/OSCelot/
cp -r OSCelot_plugin/dist/OSCelot/* %{buildroot}%{_libexecdir}/Rack2/plugins/OSCelot/
