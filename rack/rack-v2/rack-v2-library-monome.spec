...
%global commit0 a60f6763f47ceea3acd1f4c0746ed9d35b8d8cb2
%global gittag0 2.2.8
...
Source0: Rack.tar.gz
Source1: monome-rack.tar.gz
Source2: monome_plugin.json
...
sed -i -e "/export/d" monome_plugin/Makefile
sed -i -e "s/-C//g" monome_plugin/firmware/teletype.mk
sed -i -e "s/all: firmware-build/all:/g" monome_plugin/Makefile
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/monome/
cp -r monome_plugin/dist/monome/* %{buildroot}%{_libexecdir}/Rack2/plugins/monome/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.2.8-1
- initial specfile
