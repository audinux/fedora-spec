...
%global commit0 c1c62e0f8a766c25e4f1848c9e4f5d56253ef34a
%global gittag0 2.0.0-beta 4
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Ohmer/
cp -r Ohmer_plugin/dist/Ohmer/* %{buildroot}%{_libexecdir}/Rack2/plugins/Ohmer/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.0.0-beta 4-1
- initial specfile
