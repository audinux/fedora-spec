...
%global commit0 873bd7f5cdec102d01f9dad06e5fc926158f678e
...
URL:     https://github.com/imDanSable/SIM
...
Source0: Rack.tar.gz
Source1: https://github.com/imDanSable/SIM/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SIM_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SIM/
cp -r SIM_plugin/dist/SIM/* %{buildroot}%{_libexecdir}/Rack2/plugins/SIM/
