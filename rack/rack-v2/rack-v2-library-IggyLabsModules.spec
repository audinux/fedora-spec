...
%global commit0 91e9bcdde24ef6d32a14308ea83da562fb914a1d
...
Name:    rack-v2-IggyLabsModules
Version: 2.0.0
Release: 1%{?dist}
Summary: IggyLabsModules plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/isabelgk/IggyLabsModules
...
Source0: Rack.tar.gz
Source1: https://github.com/isabelgk/IggyLabsModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
cp -n %{SOURCE2} IggyLabsModules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/IggyLabsModules/
cp -r IggyLabsModules_plugin/dist/IggyLabsModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/IggyLabsModules/
