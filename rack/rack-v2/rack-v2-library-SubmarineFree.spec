...
%global commit0 d5f1c10a069bfa52e5552b615fd7e1ca9d465dee
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SubmarineFree/
cp -r SubmarineFree_plugin/dist/SubmarineFree/* %{buildroot}%{_libexecdir}/Rack2/plugins/SubmarineFree/
