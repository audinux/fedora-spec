...
%global commit0 6cda28cfa33f4740f1e58e485780c4b12bbb076e
...
Name:    rack-v2-VectorModular
Version: 2.0.0
Release: 2%{?dist}
Summary: VectorModular plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/vectormodular/VectorModular
...
Source0: Rack.tar.gz
Source1: VectorModular.tar.gz
Source2: VectorModular_plugin.json
...
mkdir VectorModular_plugin
tar xvfz %{SOURCE1} --directory=VectorModular_plugin --strip-components=1

cp -n %{SOURCE2} VectorModular_plugin/plugin.json || true

%build

cd VectorModular_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/VectorModular/
cp -r VectorModular_plugin/dist/VectorModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/VectorModular/
