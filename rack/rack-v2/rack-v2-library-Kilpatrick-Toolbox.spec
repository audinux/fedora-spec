...
URL:     https://github.com/kilpatrickaudio/Kilpatrick-Toolbox
...
Source0: Rack.tar.gz
Source1: https://github.com/kilpatrickaudio/Kilpatrick-Toolbox/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Kilpatrick-Toolbox_plugin.json
...
%description
Kilpatrick-Toolbox plugin for Rack.
MIDI Channel Processor with vMIDI Support
...
mkdir Kilpatrick-Toolbox_plugin
tar xvfz %{SOURCE1} --directory=Kilpatrick-Toolbox_plugin --strip-components=1

cp -n %{SOURCE2} Kilpatrick-Toolbox_plugin/plugin.json || true

%build

cd Kilpatrick-Toolbox_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Kilpatrick-Toolbox/
cp -r Kilpatrick-Toolbox_plugin/dist/Kilpatrick-Toolbox/* %{buildroot}%{_libexecdir}/Rack2/plugins/Kilpatrick-Toolbox/
