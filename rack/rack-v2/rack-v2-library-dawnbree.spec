...
%global commit0 afdb178ec7938e22e39f06f4fbdb1e7267870c2c
...
Source0: Rack.tar.gz
Source1: https://github.com/jonesnxt/dawnbree/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: dawnbree_plugin.json
...
mkdir dawnbree_plugin
tar xvfz %{SOURCE1} --directory=dawnbree_plugin --strip-components=1

cp -n %{SOURCE2} dawnbree_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/dawnbree/
cp -r dawnbree_plugin/dist/dawnbree/* %{buildroot}%{_libexecdir}/Rack2/plugins/dawnbree/
