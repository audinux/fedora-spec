...
cp -n %{SOURCE2} ModularFungi_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ModularFungi/
cp -r ModularFungi_plugin/dist/ModularFungi/* %{buildroot}%{_libexecdir}/Rack2/plugins/ModularFungi/
