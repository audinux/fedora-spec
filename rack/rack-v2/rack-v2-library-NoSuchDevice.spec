...
%global commit0 faba49abe54a1c4f698fd134759281fad2e5693d
...
Name:    rack-v2-NoSuchDevice
Version: 2.1.4
Release: 2%{?dist}
Summary: NoSuchDevice plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/thorinside/NoSuchDevice
...
Source0: Rack.tar.gz
Source1: NoSuchDevice.tar.gz
Source2: NoSuchDevice_plugin.json
...
mkdir NoSuchDevice_plugin
tar xvfz %{SOURCE1} --directory=NoSuchDevice_plugin --strip-components=1

cp -n %{SOURCE2} NoSuchDevice_plugin/plugin.json || true

%build

cd NoSuchDevice_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NoSuchDevice/
cp -r NoSuchDevice_plugin/dist/NoSuchDevice/* %{buildroot}%{_libexecdir}/Rack2/plugins/NoSuchDevice/
