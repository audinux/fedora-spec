...
%global commit0 3266554d0ff570ffc5a66b52585fb5b1a1e6d75c
...
cp -n %{SOURCE2} GlueTheGiant_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/GlueTheGiant/
cp -r GlueTheGiant_plugin/dist/GlueTheGiant/* %{buildroot}%{_libexecdir}/Rack2/plugins/GlueTheGiant/
