...
cp -n %{SOURCE2} AuraAudio_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AuraAudio/
cp -r AuraAudio_plugin/dist/AuraAudio/* %{buildroot}%{_libexecdir}/Rack2/plugins/AuraAudio/
