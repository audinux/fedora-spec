...
cp -n %{SOURCE2} TercerBrazo_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/TercerBrazo/
cp -r TercerBrazo_plugin/dist/TercerBrazo/* %{buildroot}%{_libexecdir}/Rack2/plugins/TercerBrazo/
