...
cp -n %{SOURCE2} 23volts_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/23volts/
cp -r 23volts_plugin/dist/23volts/* %{buildroot}%{_libexecdir}/Rack2/plugins/23volts/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.1.5-1
- initial specfile
