...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/mtsch-plugins/
cp -r mtsch-plugins_plugin/dist/mtsch-plugins/* %{buildroot}%{_libexecdir}/Rack2/plugins/mtsch-plugins/
