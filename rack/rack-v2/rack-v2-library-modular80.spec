...
%global commit0 6020017f6df74d61bb0ccfa7c814257dccf4d853
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/modular80/
cp -r modular80_plugin/dist/modular80/* %{buildroot}%{_libexecdir}/Rack2/plugins/modular80/
