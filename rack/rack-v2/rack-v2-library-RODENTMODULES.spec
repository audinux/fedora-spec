...
cp -n %{SOURCE2} RODENTMODULES_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RODENTMODULES/
cp -r RODENTMODULES_plugin/dist/RODENTMODULES/* %{buildroot}%{_libexecdir}/Rack2/plugins/RODENTMODULES/
