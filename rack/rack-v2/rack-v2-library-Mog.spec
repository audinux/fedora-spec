...
cp -n %{SOURCE2} Mog_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Mog/
cp -r Mog_plugin/dist/Mog/* %{buildroot}%{_libexecdir}/Rack2/plugins/Mog/
