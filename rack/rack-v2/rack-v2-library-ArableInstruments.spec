...
Name:    rack-v2-ArableInstruments
Version: 1.0.0
Release: 1%{?dist}
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ArableInstruments/
cp -r ArableInstruments_plugin/dist/ArableInstruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/ArableInstruments/
