...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RJModules/
cp -r RJModules_plugin/dist/RJModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/RJModules/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.7.2-1
- initial specfile
