...
%global commit0 78e1b1c9ff889bc5bfec85550b0a382ae8cfb845
...
cp -n %{SOURCE2} LunettaModula_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LunettaModula/
cp -r LunettaModula_plugin/dist/LunettaModula/* %{buildroot}%{_libexecdir}/Rack2/plugins/LunettaModula/
