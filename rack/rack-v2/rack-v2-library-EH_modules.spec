...
cp -n %{SOURCE2} EH_modules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/EH_modules/
cp -r EH_modules_plugin/dist/EH_modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/EH_modules/
