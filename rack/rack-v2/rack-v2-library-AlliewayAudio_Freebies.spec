...
%global commit0 cff07c47c23e843df4963303696cffdde9823838
...
Source0: Rack.tar.gz
Source1: https://github.com/AlliewayAudio/AlliewayAudio_Freebies/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AlliewayAudio_Freebies_plugin.json
...
%description
AlliewayAudio_Freebies plugin for Rack.
...
mkdir AlliewayAudio_Freebies_plugin
tar xvfz %{SOURCE1} --directory=AlliewayAudio_Freebies_plugin --strip-components=1 

cp -n %{SOURCE2} AlliewayAudio_Freebies_plugin/plugin.json || true

%build

cd AlliewayAudio_Freebies_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AlliewayAudio_Freebies/
cp -r AlliewayAudio_Freebies_plugin/dist/AlliewayAudio_Freebies/* %{buildroot}%{_libexecdir}/Rack2/plugins/AlliewayAudio_Freebies/
