...
cp -n %{SOURCE2} rcm_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/rcm/
cp -r rcm_plugin/dist/rcm/* %{buildroot}%{_libexecdir}/Rack2/plugins/rcm/
