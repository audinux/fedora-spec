...
%global commit0 6577880b5680c0b6487ff981de468bfe117a6f0a
...
cp -n %{SOURCE2} AnimatedCircuits_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AnimatedCircuits/
cp -r AnimatedCircuits_plugin/dist/AnimatedCircuits/* %{buildroot}%{_libexecdir}/Rack2/plugins/AnimatedCircuits/
