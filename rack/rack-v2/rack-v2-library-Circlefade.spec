...
cp -n %{SOURCE2} Circlefade_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Circlefade/
cp -r Circlefade_plugin/dist/Circlefade/* %{buildroot}%{_libexecdir}/Rack2/plugins/Circlefade/
