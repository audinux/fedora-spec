...
%global commit0 2802604321d286cfdd263aafdf7fd0468ebd8069
%global gittag0 2.4.45
...
cp -n %{SOURCE2} Bogaudio_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Bogaudio/
cp -r Bogaudio_plugin/dist/Bogaudio/* %{buildroot}%{_libexecdir}/Rack2/plugins/Bogaudio/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.4.45-1
- initial specfile
