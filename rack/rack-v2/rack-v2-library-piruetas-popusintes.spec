...
%global commit0 ce7f5db718c50865eb971368ddfb20cfcce6f4be
...
URL: https://github.com/piruetasxyz/popusintes-rack
...
Source0: Rack.tar.gz
Source1: https://github.com/piruetasxyz/popusintes-rack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: piruetas-popusintes_plugin.json
...
mkdir piruetas-popusintes_plugin
tar xvfz %{SOURCE1} --directory=piruetas-popusintes_plugin --strip-components=1

cp -n %{SOURCE2} piruetas-popusintes_plugin/plugin.json || true

%build

cd piruetas-popusintes_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/piruetas-popusintes/
cp -r piruetas-popusintes_plugin/dist/piruetas-popusintes/* %{buildroot}%{_libexecdir}/Rack2/plugins/piruetas-popusintes/
