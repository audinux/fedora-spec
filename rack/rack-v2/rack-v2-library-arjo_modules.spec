...
cp -n %{SOURCE2} arjo_modules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/arjo_modules/
cp -r arjo_modules_plugin/dist/arjo_modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/arjo_modules/
