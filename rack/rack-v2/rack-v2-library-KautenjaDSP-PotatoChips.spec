...
%global commit0 fc5eaebf1b8a363abca8019b68f489238026e154
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/KautenjaDSP-PotatoChips/
cp -r KautenjaDSP-PotatoChips_plugin/dist/KautenjaDSP-PotatoChips/* %{buildroot}%{_libexecdir}/Rack2/plugins/KautenjaDSP-PotatoChips/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.11.0-1
- initial specfile
