...
%global commit0 3bcad57fb308e7d4783b191bc7c52d55c0740846
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Mojo/
cp -r Mojo_plugin/dist/Mojo/* %{buildroot}%{_libexecdir}/Rack2/plugins/Mojo/
