...
cp -n %{SOURCE2} AaronStatic_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AaronStatic/
cp -r AaronStatic_plugin/dist/AaronStatic/* %{buildroot}%{_libexecdir}/Rack2/plugins/AaronStatic/
