...
cp -n %{SOURCE2} Skylights_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Skylights/
cp -r Skylights_plugin/dist/Skylights/* %{buildroot}%{_libexecdir}/Rack2/plugins/Skylights/
