...
Name:    rack-v2-Southpole-parasites
Version: 0.6.0
Release: 1%{?dist}
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Southpole-parasites/
cp -r Southpole-parasites_plugin/dist/Southpole-parasites/* %{buildroot}%{_libexecdir}/Rack2/plugins/Southpole-parasites/
