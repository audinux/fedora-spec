...
cp -n %{SOURCE2} noobhour_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/noobhour/
cp -r noobhour_plugin/dist/noobhour/* %{buildroot}%{_libexecdir}/Rack2/plugins/noobhour/
