...
%global commit0 30b3c6c46fc0589f5e0ece7ad79abbe0293e70fd
...
cp -n %{SOURCE2} CountModula_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CountModula/
cp -r CountModula_plugin/dist/CountModula/* %{buildroot}%{_libexecdir}/Rack2/plugins/CountModula/
