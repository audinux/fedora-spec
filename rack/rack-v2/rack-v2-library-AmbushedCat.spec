...
%global commit0 6bf67cd62a34bbcead43fb4f4f8510c4c04ac4d1
...
Name:    rack-v2-AmbushedCat
Version: 2.0.0
Release: 2%{?dist}
Summary: AmbushedCat plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/LegitCodeRed/AmbushedCat
...
Source0: Rack.tar.gz
Source1: https://github.com/LegitCodeRed/AmbushedCat/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AmbushedCat_plugin.json
...
mkdir AmbushedCat_plugin
tar xvfz %{SOURCE1} --directory=AmbushedCat_plugin --strip-components=1

cp -n %{SOURCE2} AmbushedCat_plugin/plugin.json || true

%build

cd AmbushedCat_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AmbushedCat/
cp -r AmbushedCat_plugin/dist/AmbushedCat/* %{buildroot}%{_libexecdir}/Rack2/plugins/AmbushedCat/
