...
%global commit0 7fa8e8a650877d7ac5d99d8731923a2f544aeda4
%global gittag0 2.7.4
...
URL:     https://github.com/chinenual/Chinenual-VCV
...
Source0: Rack.tar.gz
Source1: https://github.com/chinenual/Chinenual-VCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Chinenual-VCV_plugin.json
...
cd Chinenual-VCV_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Chinenual-VCV/
cp -r Chinenual-VCV_plugin/dist/Chinenual-VCV/* %{buildroot}%{_libexecdir}/Rack2/plugins/Chinenual-VCV/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.7.4-1
- initial specfile
