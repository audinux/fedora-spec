...
cp -n %{SOURCE2} NoraCodes_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NoraCodes/
cp -r NoraCodes_plugin/dist/NoraCodes/* %{buildroot}%{_libexecdir}/Rack2/plugins/NoraCodes/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.2.2-1
- initial specfile
