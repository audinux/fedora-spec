...
%global commit0 7a96486e439565b4449db14b6ad0ccb0cec7c9ab
...
cp -n %{SOURCE2} aridacity_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/aridacity/
cp -r aridacity_plugin/dist/aridacity/* %{buildroot}%{_libexecdir}/Rack2/plugins/aridacity/
