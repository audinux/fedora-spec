...
%global commit0 27b873c8b974a97543572125df728c43be86fa9b
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CaptainsSounds/
cp -r CaptainsSounds_plugin/dist/CaptainsSounds/* %{buildroot}%{_libexecdir}/Rack2/plugins/CaptainsSounds/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.0.7-1
- initial specfile
