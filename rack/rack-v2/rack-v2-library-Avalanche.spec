...
%global commit0 b3c19130876ae04814f77af65638cbee898faf0f
...
Name: rack-v2-Avalanche
Version: 2.0.0
Release: 2%{?dist}
Summary: Avalanche plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/xorioz/Avalanche
...
Source0: Rack.tar.gz
Source1: https://github.com/xorioz/Avalanche/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Avalanche_plugin.json
...
%description
Avalanche plugin for Rack.
Akai MIDIMix fader/knob bank with bidirectional LED feedback
...
mkdir Avalanche_plugin
tar xvfz %{SOURCE1} --directory=Avalanche_plugin --strip-components=1

cp -n %{SOURCE2} Avalanche_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Avalanche/
cp -r Avalanche_plugin/dist/Avalanche/* %{buildroot}%{_libexecdir}/Rack2/plugins/Avalanche/
