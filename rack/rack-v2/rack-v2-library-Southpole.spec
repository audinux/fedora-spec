...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Southpole/
cp -r Southpole_plugin/dist/Southpole/* %{buildroot}%{_libexecdir}/Rack2/plugins/Southpole/
