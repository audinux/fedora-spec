...
%global commit0 75e5f709197de54fcc51e8b6df2facc5ced767c6
%global gittag0 2.1.14
...
%description
questionablemodules plugin for Rack.
...
mkdir questionablemodules_plugin
tar xvfz %{SOURCE1} --directory=questionablemodules_plugin --strip-components=1

cp -n %{SOURCE2} questionablemodules_plugin/plugin.json || true

%build

cd questionablemodules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/questionablemodules/
cp -r questionablemodules_plugin/dist/questionablemodules/* %{buildroot}%{_libexecdir}/Rack2/plugins/questionablemodules/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.1.14-1
- initial specfile
