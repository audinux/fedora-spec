...
%global commit0 2284e4a3befb097b42ae30032147fd61226f64ff
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AS/
cp -r AS_plugin/dist/AS/* %{buildroot}%{_libexecdir}/Rack2/plugins/AS/
