...
%global commit0 5b19201685d472b0d7ccfd17a1429e2cb9c86cd3
...
cp -n %{SOURCE2} ImpromptuModular_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ImpromptuModular/
cp -r ImpromptuModular_plugin/dist/ImpromptuModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/ImpromptuModular/
