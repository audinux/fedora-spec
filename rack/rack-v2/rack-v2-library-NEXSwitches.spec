...
cp -n %{SOURCE2} NEXSwitches_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NEXSwitches/
cp -r NEXSwitches_plugin/dist/NEXSwitches/* %{buildroot}%{_libexecdir}/Rack2/plugins/NEXSwitches/
