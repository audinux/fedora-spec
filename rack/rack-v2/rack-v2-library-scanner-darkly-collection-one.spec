...
%global commit0 70a282a76d3a6da7fb84dd45aa1e4670538a951e
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/scanner-darkly-collection-one/
cp -r scanner-darkly-collection-one_plugin/dist/scanner-darkly-collection-one/* %{buildroot}%{_libexecdir}/Rack2/plugins/scanner-darkly-collection-one/
