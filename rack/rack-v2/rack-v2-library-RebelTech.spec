...
%global commit0 2c2691f261916e2e749750fb0838fc13d4d0784b
...
Source0: Rack.tar.gz
Source1: https://github.com/hemmer/rebel-tech-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: RebelTech_plugin.json
...
mkdir RebelTech_plugin
tar xvfz %{SOURCE1} --directory=RebelTech_plugin --strip-components=1 

cp -n %{SOURCE2} RebelTech_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RebelTech/
cp -r RebelTech_plugin/dist/RebelTech/* %{buildroot}%{_libexecdir}/Rack2/plugins/RebelTech/
