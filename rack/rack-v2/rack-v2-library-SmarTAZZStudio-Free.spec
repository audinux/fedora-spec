...
%global commit0 c0a3e3f2d950b1a235d5aad254777f4ab578c660
...
Source0: Rack.tar.gz
Source1: https://github.com/mlaban64/STS-Free/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SmarTAZZStudio-Free_plugin.json
...
%description
SmarTAZZStudio-Free plugin for Rack.
...
mkdir SmarTAZZStudio-Free_plugin
tar xvfz %{SOURCE1} --directory=SmarTAZZStudio-Free_plugin --strip-components=1

cp -n %{SOURCE2} SmarTAZZStudio-Free_plugin/plugin.json || true

%build

cd SmarTAZZStudio-Free_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SmarTAZZStudio-Free/
cp -r SmarTAZZStudio-Free_plugin/dist/SmarTAZZStudio-Free/* %{buildroot}%{_libexecdir}/Rack2/plugins/SmarTAZZStudio-Free/
