...
%global commit0 faad00d551bfecd83b9b7363795aadbcd8483059
...
cp -n %{SOURCE2} Comfortzone_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Comfortzone/
cp -r Comfortzone_plugin/dist/Comfortzone/* %{buildroot}%{_libexecdir}/Rack2/plugins/Comfortzone/
