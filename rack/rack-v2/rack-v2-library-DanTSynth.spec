...
%global commit0 d185f768d708df6b608559b97cccffaf794680a8
...
Name:    rack-v2-DanTSynth
Version: 2.0.1
Release: 2%{?dist}
Summary: DanTSynth plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/Miff-Real/DanT.Synth
...
Source0: Rack.tar.gz
Source1: https://github.com/Miff-Real/DanT.Synth/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: DanTSynth_plugin.json
...
%description
DanTSynth plugin for Rack.
[5HP][Polyphonic] Attenuverter & Offset & Clip & Rectify. Reorderable.
...
mkdir DanTSynth_plugin
tar xvfz %{SOURCE1} --directory=DanTSynth_plugin --strip-components=1

cp -n %{SOURCE2} DanTSynth_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/DanTSynth/
cp -r DanTSynth_plugin/dist/DanTSynth/* %{buildroot}%{_libexecdir}/Rack2/plugins/DanTSynth/
