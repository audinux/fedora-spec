...
%global commit0 8357c68f14d155e6935f954648ec80b2f61f8619
...
Source0: Rack.tar.gz
Source1: https://github.com/gibbonjoyeux/VCV-Biset/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Biset_plugin.json
...
mkdir Biset_plugin
tar xvfz %{SOURCE1} --directory=Biset_plugin --strip-components=1

cp -n %{SOURCE2} Biset_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Biset/
cp -r Biset_plugin/dist/Biset/* %{buildroot}%{_libexecdir}/Rack2/plugins/Biset/
