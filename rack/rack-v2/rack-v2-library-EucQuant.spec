...
%global commit0 9b3250c816695bed1369331c130b9abc6c3e2cd0
...
Source0: Rack.tar.gz
Source1: https://github.com/sindarknave/EucQuant/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: EucQuant_plugin.json
...
mkdir EucQuant_plugin
tar xvfz %{SOURCE1} --directory=EucQuant_plugin --strip-components=1 

cp -n %{SOURCE2} EucQuant_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/EucQuant/
cp -r EucQuant_plugin/dist/EucQuant/* %{buildroot}%{_libexecdir}/Rack2/plugins/EucQuant/
