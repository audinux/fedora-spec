...
%global commit0 4a148ffea5ab569f28df876661e0bd529160858e
...
cp -n %{SOURCE2} Interrobang_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Interrobang/
cp -r Interrobang_plugin/dist/Interrobang/* %{buildroot}%{_libexecdir}/Rack2/plugins/Interrobang/
