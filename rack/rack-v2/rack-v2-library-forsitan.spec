...
%global commit0 484fa8303b303915df6237fff6531107564d1f38
%global gittag0 2.13.3
...
Source0: Rack.tar.gz
Source1: https://github.com/gosub/forsitan-modulare/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: forsitan_plugin.json
...
mkdir forsitan_plugin
tar xvfz %{SOURCE1} --directory=forsitan_plugin --strip-components=1

cp -n %{SOURCE2} forsitan_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/forsitan/
cp -r forsitan_plugin/dist/forsitan/* %{buildroot}%{_libexecdir}/Rack2/plugins/forsitan/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.13.3-1
- initial specfile
