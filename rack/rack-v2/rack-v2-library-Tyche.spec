...
%global commit0 eef96dbd6933bf42cb89a7a2f242f1cf5ff3d192
...
Source0: Rack.tar.gz
Source1: VCVTyche.tar.gz
Source2: Tyche_plugin.json
...
%description
Tyche plugin for Rack.
Controls the seed of the other Tyche modules
...
mkdir Tyche_plugin
tar xvfz %{SOURCE1} --directory=Tyche_plugin --strip-components=1

cp -n %{SOURCE2} Tyche_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Tyche/
cp -r Tyche_plugin/dist/Tyche/* %{buildroot}%{_libexecdir}/Rack2/plugins/Tyche/
