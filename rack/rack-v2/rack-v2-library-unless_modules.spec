...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/unless_modules/
cp -r unless_modules_plugin/dist/unless_modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/unless_modules/
