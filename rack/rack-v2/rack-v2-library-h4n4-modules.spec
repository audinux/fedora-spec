...
%global commit0 d68c2f9c95fe2781920c39557888616dcad6d007
...
Source0: Rack.tar.gz
Source1: https://github.com/hannakoppelaar/h4n4-modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: h4n4-modules_plugin.json
...
mkdir h4n4-modules_plugin
tar xvfz %{SOURCE1} --directory=h4n4-modules_plugin --strip-components=1

cp -n %{SOURCE2} h4n4-modules_plugin/plugin.json || true

%build

cd h4n4-modules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/h4n4-modules/
cp -r h4n4-modules_plugin/dist/h4n4-modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/h4n4-modules/
