...
%global commit0 9e0cfa31c8c11a6601a62ae34efdcabff501881f
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ML_modules/
cp -r ML_modules_plugin/dist/ML_modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/ML_modules/
