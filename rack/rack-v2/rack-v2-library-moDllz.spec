...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/moDllz/
cp -r moDllz_plugin/dist/moDllz/* %{buildroot}%{_libexecdir}/Rack2/plugins/moDllz/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.1.7-1
- initial specfile
