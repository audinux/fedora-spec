...
%global commit0 3409eadde21ba15750a7b5a607f960f892074adc
...
cp -n %{SOURCE2} Atelier_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Atelier/
cp -r Atelier_plugin/dist/Atelier/* %{buildroot}%{_libexecdir}/Rack2/plugins/Atelier/
