...
%global commit0 762045d4be877195ceb4297f53bc129d359b6aa3
...
Name:    rack-v2-LempModules
Version: 2.0.0
Release: 2%{?dist}
Summary: LempModules plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/lempface/VCV-LempModules
...
Source0: Rack.tar.gz
Source1: https://github.com/lempface/VCV-LempModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: LempModules_plugin.json
...
mkdir LempModules_plugin
tar xvfz %{SOURCE1} --directory=LempModules_plugin --strip-components=1

cp -n %{SOURCE2} LempModules_plugin/plugin.json || true

%build

cd LempModules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LempModules/
cp -r LempModules_plugin/dist/LempModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/LempModules/
