...
cp -n %{SOURCE2} SLM_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SLM/
cp -r SLM_plugin/dist/SLM/* %{buildroot}%{_libexecdir}/Rack2/plugins/SLM/
