...
%global commit0 737bfe3a367d7126648e0bdec7f4117e002cf060
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RPJ/
cp -r RPJ_plugin/dist/RPJ/* %{buildroot}%{_libexecdir}/Rack2/plugins/RPJ/
