...
%global commit0 c9f3a53ed5272af98d97819a44cde2769fb1462d
...
cp -n %{SOURCE2} TinyTricks_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/TinyTricks/
cp -r TinyTricks_plugin/dist/TinyTricks/* %{buildroot}%{_libexecdir}/Rack2/plugins/TinyTricks/
