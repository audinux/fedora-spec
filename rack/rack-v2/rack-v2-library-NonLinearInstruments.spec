...
Name:    rack-v2-NonLinearInstruments
Version: 2.0.0
Release: 2%{?dist}
...
cp -n %{SOURCE2} NonLinearInstruments_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NonLinearInstruments/
cp -r NonLinearInstruments_plugin/dist/NonLinearInstruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/NonLinearInstruments/
