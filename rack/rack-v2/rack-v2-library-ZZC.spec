...
%global commit0 3f12cb06b974e7b9c6c80d84cff955c7c680d5b4
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ZZC/
cp -r ZZC_plugin/dist/ZZC/* %{buildroot}%{_libexecdir}/Rack2/plugins/ZZC/
