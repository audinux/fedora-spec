...
cp -n %{SOURCE2} Mantra_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Mantra/
cp -r Mantra_plugin/dist/Mantra/* %{buildroot}%{_libexecdir}/Rack2/plugins/Mantra/
