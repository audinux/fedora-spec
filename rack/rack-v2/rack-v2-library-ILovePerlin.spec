...
cp -n %{SOURCE2} ILovePerlin_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ILovePerlin/
cp -r ILovePerlin_plugin/dist/ILovePerlin/* %{buildroot}%{_libexecdir}/Rack2/plugins/ILovePerlin/
