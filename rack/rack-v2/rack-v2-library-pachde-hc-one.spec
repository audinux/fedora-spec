...
%global commit0 c34a296305f627798934d3999faa65c30bc06005
...
Name:    rack-v2-pachde-hc-one
Version: 2.0.0
Release: 2%{?dist}
Summary: pachde-hc-one plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/Paul-Dempsey/pachde-hc-one
...
Source0: Rack.tar.gz
Source1: https://github.com/Paul-Dempsey/pachde-hc-one/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: pachde-hc-one_plugin.json
...
mkdir pachde-hc-one_plugin
tar xvfz %{SOURCE1} --directory=pachde-hc-one_plugin --strip-components=1

cp -n %{SOURCE2} pachde-hc-one_plugin/plugin.json || true

%build

cd pachde-hc-one_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/pachde-hc-one/
cp -r pachde-hc-one_plugin/dist/pachde-hc-one/* %{buildroot}%{_libexecdir}/Rack2/plugins/pachde-hc-one/
