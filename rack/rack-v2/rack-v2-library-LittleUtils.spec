...
%global commit0 46939264c5081187c5dbc481e4d4a0667eafd473
...
cp -n %{SOURCE2} LittleUtils_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LittleUtils/
cp -r LittleUtils_plugin/dist/LittleUtils/* %{buildroot}%{_libexecdir}/Rack2/plugins/LittleUtils/
