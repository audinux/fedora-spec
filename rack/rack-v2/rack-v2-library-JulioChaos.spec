...
URL:     https://github.com/JulioArgudo/JulioChaos-modules
...
Source0: Rack.tar.gz
Source1: https://github.com/JulioArgudo/JulioChaos-modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: JulioChaos_plugin.json
...
mkdir JulioChaos_plugin
tar xvfz %{SOURCE1} --directory=JulioChaos_plugin --strip-components=1

cp -n %{SOURCE2} JulioChaos_plugin/plugin.json || true

%build

cd JulioChaos_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/JulioChaos/
cp -r JulioChaos_plugin/dist/JulioChaos/* %{buildroot}%{_libexecdir}/Rack2/plugins/JulioChaos/
