...
%global commit0 1b0a1d9c5adb9961a868a699b693560e1a6c5170
...
Name: rack-v2-Kalliste
Version: 2.0.1
Release: 2%{?dist}
Summary: Kalliste plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/GabTiorbi/Kalliste
...
Source0: Rack.tar.gz
Source1: https://github.com/GabTiorbi/Kalliste/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Kalliste_plugin.json
...
%description
Kalliste plugin for Rack.
Polyphonic chord arpeggiator
...
mkdir Kalliste_plugin
tar xvfz %{SOURCE1} --directory=Kalliste_plugin --strip-components=1

cp -n %{SOURCE2} Kalliste_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Kalliste/
cp -r Kalliste_plugin/dist/Kalliste/* %{buildroot}%{_libexecdir}/Rack2/plugins/Kalliste/
