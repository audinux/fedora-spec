...
URL: https://github.com/AndyClotta/Interactive-Rhythm-Composer
...
Source0: Rack.tar.gz
Source1: https://github.com/AndyClotta/Interactive-Rhythm-Composer/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: FreezerLabs_plugin.json
...
mkdir FreezerLabs_plugin
tar xvfz %{SOURCE1} --directory=FreezerLabs_plugin --strip-components=1

cp -n %{SOURCE2} FreezerLabs_plugin/plugin.json || true

%build

cd FreezerLabs_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/FreezerLabs/
cp -r FreezerLabs_plugin/dist/FreezerLabs/* %{buildroot}%{_libexecdir}/Rack2/plugins/FreezerLabs/
