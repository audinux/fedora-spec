...
cp -n %{SOURCE2} ChordController_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ChordController/
cp -r ChordController_plugin/dist/ChordController/* %{buildroot}%{_libexecdir}/Rack2/plugins/ChordController/
