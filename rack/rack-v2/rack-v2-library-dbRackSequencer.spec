...
%global commit0 a2eb63edb6011a549871f8502e27d811a0ae92f5
%global gittag0 2.6.3
...
Source2: dbRackSequencer_plugin.json
...
%description
dbRackSequencer plugin for Rack.
...
mkdir dbRackSequencer_plugin
tar xvfz %{SOURCE1} --directory=dbRackSequencer_plugin --strip-components=1

cp -n %{SOURCE2} dbRackSequencer_plugin/plugin.json || true

%build

cd dbRackSequencer_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/dbRackSequencer/
cp -r dbRackSequencer_plugin/dist/dbRackSequencer/* %{buildroot}%{_libexecdir}/Rack2/plugins/dbRackSequencer/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.6.3-1
- initial specfile
