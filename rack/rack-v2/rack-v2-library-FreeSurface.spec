...
%global commit0 ebe26a567ae5fd23aa63dbd64ef4b0c49599be9f
...
Source0: Rack.tar.gz
Source1: https://github.com/freesurfacemodules/FreeSurface/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: FreeSurface_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/FreeSurface/
cp -r FreeSurface_plugin/dist/FreeSurface/* %{buildroot}%{_libexecdir}/Rack2/plugins/FreeSurface/
