...
%global commit0 e2c4f7b964b90ec2cc83de5b35268cbaad31ae5d
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/kocmoc/
cp -r kocmoc_plugin/dist/kocmoc/* %{buildroot}%{_libexecdir}/Rack2/plugins/kocmoc/
