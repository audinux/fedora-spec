...
%global commit0 3d327f6bacf41eb18bec7e63c61531685ee799de
...
cp -n %{SOURCE2} Extratone_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Extratone/
cp -r Extratone_plugin/dist/Extratone/* %{buildroot}%{_libexecdir}/Rack2/plugins/Extratone/
