...
URL:     https://github.com/CHLOzzz/MML
...
mkdir MML_plugin
tar xvfz %{SOURCE1} --directory=MML_plugin --strip-components=1

cp -n %{SOURCE2} MML_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MML/
cp -r MML_plugin/dist/MML/* %{buildroot}%{_libexecdir}/Rack2/plugins/MML/
