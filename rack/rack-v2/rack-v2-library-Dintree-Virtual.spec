...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Dintree-Virtual/
cp -r Dintree-Virtual_plugin/dist/Dintree-Virtual/* %{buildroot}%{_libexecdir}/Rack2/plugins/Dintree-Virtual/
