...
%global commit0 11930962317416cda079d16bd56482316964fd81
...
cp -n %{SOURCE2} WhatTheRack_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/WhatTheRack/
cp -r WhatTheRack_plugin/dist/WhatTheRack/* %{buildroot}%{_libexecdir}/Rack2/plugins/WhatTheRack/
