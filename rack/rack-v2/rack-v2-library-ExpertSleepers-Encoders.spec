...
%global commit0 95496e8a955407889bbab94cf404cf356802bb76
...
Name:    rack-v2-ExpertSleepers-Encoders
Version: 2.1.0
Release: 1%{?dist}
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ExpertSleepers-Encoders/
cp -r ExpertSleepers-Encoders_plugin/dist/ExpertSleepers-Encoders/* %{buildroot}%{_libexecdir}/Rack2/plugins/ExpertSleepers-Encoders/
