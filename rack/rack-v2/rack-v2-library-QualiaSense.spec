...
%global commit0 e77b428facaaf09fe79f8c094456c6c38bb69cbc
...
Name: rack-v2-QualiaSense
Version: 2.0.0
Release: 2%{?dist}
Summary: QualiaSense plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/qualiatouch/qualiasense-plugin
...
Source0: Rack.tar.gz
Source1: https://github.com/qualiatouch/qualiasense-plugin/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: QualiaSense_plugin.json
...
%description
QualiaSense plugin for Rack.
Receives smartphone sensor data from PhyPhox app to command CV signals.
...
mkdir QualiaSense_plugin
tar xvfz %{SOURCE1} --directory=QualiaSense_plugin --strip-components=1

cp -n %{SOURCE2} QualiaSense_plugin/plugin.json || true

%build

cd QualiaSense_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/QualiaSense/
cp -r QualiaSense_plugin/dist/QualiaSense/* %{buildroot}%{_libexecdir}/Rack2/plugins/QualiaSense/
