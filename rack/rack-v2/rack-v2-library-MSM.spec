...
%global commit0 da38052ab9bc846a7d0ed40471a39f943bef89c2
...
%description
MSM plugin for Rack.
ADSR Envelope Generator with modifiable curve shapes
...
cp -n %{SOURCE2} MSM_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MSM/
cp -r MSM_plugin/dist/MSM/* %{buildroot}%{_libexecdir}/Rack2/plugins/MSM/
