...
%global commit0 68d874522c58608650c223c02c10d54a2c8fa205
...
Source0: Rack.tar.gz
Source1: https://github.com/hemmer/bastl-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Bastl_plugin.json
...
mkdir Bastl_plugin
tar xvfz %{SOURCE1} --directory=Bastl_plugin --strip-components=1

cp -n %{SOURCE2} Bastl_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Bastl/
cp -r Bastl_plugin/dist/Bastl/* %{buildroot}%{_libexecdir}/Rack2/plugins/Bastl/
