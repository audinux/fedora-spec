...
%global commit0 83746f7cbcaa491c1e55e5b576f4b6abed7999e7
...
Name:    rack-v2-WaveOfHormuz
Version: 2.2.0
Release: 2%{?dist}
Summary: WaveOfHormuz plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/quaternionmedia/waveofhormuz
...
Source0: Rack.tar.gz
Source1: https://github.com/quaternionmedia/waveofhormuz/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: WaveOfHormuz_plugin.json
...
mkdir WaveOfHormuz_plugin
tar xvfz %{SOURCE1} --directory=WaveOfHormuz_plugin --strip-components=1

cp -n %{SOURCE2} WaveOfHormuz_plugin/plugin.json || true

%build

cd WaveOfHormuz_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/WaveOfHormuz/
cp -r WaveOfHormuz_plugin/dist/WaveOfHormuz/* %{buildroot}%{_libexecdir}/Rack2/plugins/WaveOfHormuz/
