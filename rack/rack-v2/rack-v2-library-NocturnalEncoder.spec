...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NocturnalEncoder/
cp -r NocturnalEncoder_plugin/dist/NocturnalEncoder/* %{buildroot}%{_libexecdir}/Rack2/plugins/NocturnalEncoder/
