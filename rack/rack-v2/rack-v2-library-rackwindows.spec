...
cp -n %{SOURCE2} rackwindows_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/rackwindows/
cp -r rackwindows_plugin/dist/rackwindows/* %{buildroot}%{_libexecdir}/Rack2/plugins/rackwindows/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 1.1.2-1
- initial specfile
