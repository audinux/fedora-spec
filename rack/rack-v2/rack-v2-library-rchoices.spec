...
%global commit0 0a84df93acd754c9656f735475049b162176ca45
...
cp -n %{SOURCE2} rchoices_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/rchoices/
cp -r rchoices_plugin/dist/rchoices/* %{buildroot}%{_libexecdir}/Rack2/plugins/rchoices/
