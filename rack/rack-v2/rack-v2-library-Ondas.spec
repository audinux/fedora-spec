...
URL:     https://github.com/srsergiorodriguez/ondas
...
Source0: Rack.tar.gz
Source1: https://github.com/srsergiorodriguez/ondas/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Ondas_plugin.json
...
mkdir Ondas_plugin
tar xvfz %{SOURCE1} --directory=Ondas_plugin --strip-components=1

cp -n %{SOURCE2} Ondas_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Ondas/
cp -r Ondas_plugin/dist/Ondas/* %{buildroot}%{_libexecdir}/Rack2/plugins/Ondas/
