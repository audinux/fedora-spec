...
%global commit0 001475dfbf2ff42674283290b01503635ea5ba4e
...
URL: https://github.com/wintocode/wintoid-vcv
...
Source0: Rack.tar.gz
Source1: https://github.com/wintocode/wintoid-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: wintoid_plugin.json
...
mkdir wintoid_plugin
tar xvfz %{SOURCE1} --directory=wintoid_plugin --strip-components=1

cp -n %{SOURCE2} wintoid_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/wintoid/
cp -r wintoid_plugin/dist/wintoid/* %{buildroot}%{_libexecdir}/Rack2/plugins/wintoid/
