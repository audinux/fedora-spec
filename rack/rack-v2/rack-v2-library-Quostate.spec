...
%global commit0 f37b9b474568ec944125599f7f249333c08e6eb1
...
Name: rack-v2-Quostate
Version: 2.2.2
Release: 2%{?dist}
Summary: Quostate plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/HiddenSide/Quostate
...
Source0: Rack.tar.gz
Source1: https://github.com/HiddenSide/Quostate/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Quostate_plugin.json
...
%description
Quostate plugin for Rack.
sequencer that uses rules which can self-trigger or trigger other rules
...
mkdir Quostate_plugin
tar xvfz %{SOURCE1} --directory=Quostate_plugin --strip-components=1

cp -n %{SOURCE2} Quostate_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Quostate/
cp -r Quostate_plugin/dist/Quostate/* %{buildroot}%{_libexecdir}/Rack2/plugins/Quostate/
