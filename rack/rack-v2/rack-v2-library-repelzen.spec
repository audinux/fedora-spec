...
cp -n %{SOURCE2} repelzen_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/repelzen/
cp -r repelzen_plugin/dist/repelzen/* %{buildroot}%{_libexecdir}/Rack2/plugins/repelzen/
