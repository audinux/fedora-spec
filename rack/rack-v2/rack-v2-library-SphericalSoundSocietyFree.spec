...
%global commit0 f086c411a8889aea2e4b42d1c18182fb651e4875
...
Name: rack-v2-SphericalSoundSocietyFree
Version: 2.0.0
Release: 2%{?dist}
Summary: SphericalSoundSocietyFree plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/spherical-sound-society/VCV-Free
...
Source0: Rack.tar.gz
Source1: https://github.com/spherical-sound-society/VCV-Free/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SphericalSoundSocietyFree_plugin.json
...
%description
SphericalSoundSocietyFree plugin for Rack.
Bytebeat synthesizer, hardware clone
...
mkdir SphericalSoundSocietyFree_plugin
tar xvfz %{SOURCE1} --directory=SphericalSoundSocietyFree_plugin --strip-components=1

cp -n %{SOURCE2} SphericalSoundSocietyFree_plugin/plugin.json || true

%build

cd SphericalSoundSocietyFree_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SphericalSoundSocietyFree/
cp -r SphericalSoundSocietyFree_plugin/dist/SphericalSoundSocietyFree/* %{buildroot}%{_libexecdir}/Rack2/plugins/SphericalSoundSocietyFree/
