...
cp -n %{SOURCE2} SubmarineUtility_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/SubmarineUtility/
cp -r SubmarineUtility_plugin/dist/SubmarineUtility/* %{buildroot}%{_libexecdir}/Rack2/plugins/SubmarineUtility/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 0.6.2-1
- initial specfile
