...
%global commit0 1da72f216ff3636aa2ec40e1be22de45176f40bc
...
Version: 2.0.0
Release: 2%{?dist}
Summary: hrubix plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/hrubix/Invaders
...
Source0: Rack.tar.gz
Source1: https://github.com/hrubix/Invaders/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: hrubix_plugin.json
...
%description
hrubix plugin for Rack.
Hardware-emulated RGB LED matrix featuring a classic arcade animation engine with dynamic phosphor decay and CV-controlled glitch FX. This is a VCVRack version of a hardware prototype. Get in touch if you're interested in the hardware version.
...
mkdir hrubix_plugin
tar xvfz %{SOURCE1} --directory=hrubix_plugin --strip-components=1

cp -n %{SOURCE2} hrubix_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/hrubix/
cp -r hrubix_plugin/dist/hrubix/* %{buildroot}%{_libexecdir}/Rack2/plugins/hrubix/
