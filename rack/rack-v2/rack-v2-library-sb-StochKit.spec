...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/sb-StochKit/
cp -r sb-StochKit_plugin/dist/sb-StochKit/* %{buildroot}%{_libexecdir}/Rack2/plugins/sb-StochKit/
