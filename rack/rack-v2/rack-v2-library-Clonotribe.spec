...
%global commit0 2b75fcf57269be3e10b7183aa0cdcdcb9893091f
...
URL:     https://github.com/Cumbiambero/clonotribe
...
Source0: Rack.tar.gz
Source1: https://github.com/Cumbiambero/clonotribe/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Clonotribe_plugin.json
...
mkdir Clonotribe_plugin
tar xvfz %{SOURCE1} --directory=Clonotribe_plugin --strip-components=1

cp -n %{SOURCE2} Clonotribe_plugin/plugin.json || true

%build

cd Clonotribe_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Clonotribe/
cp -r Clonotribe_plugin/dist/Clonotribe/* %{buildroot}%{_libexecdir}/Rack2/plugins/Clonotribe/
