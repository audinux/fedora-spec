...
cp -n %{SOURCE2} WeldSplatter_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/WeldSplatter/
cp -r WeldSplatter_plugin/dist/WeldSplatter/* %{buildroot}%{_libexecdir}/Rack2/plugins/WeldSplatter/
