...
%global commit0 8e822066a72a671ca7c603daad0a558a9fcb58ad
...
cp -n %{SOURCE2} vitamin_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/vitamin/
cp -r vitamin_plugin/dist/vitamin/* %{buildroot}%{_libexecdir}/Rack2/plugins/vitamin/
