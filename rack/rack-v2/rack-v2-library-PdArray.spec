...
%global commit0 59d4c104b802fc5d6e199b82fc9690ae98078231
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/PdArray/
cp -r PdArray_plugin/dist/PdArray/* %{buildroot}%{_libexecdir}/Rack2/plugins/PdArray/
