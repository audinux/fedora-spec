...
URL:     https://github.com/JoBoCl/Gemini
...
Source0: Rack.tar.gz
Source1: https://github.com/JoBoCl/Gemini/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Gemini_plugin.json
...
mkdir Gemini_plugin
tar xvfz %{SOURCE1} --directory=Gemini_plugin --strip-components=1

cp -n %{SOURCE2} Gemini_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Gemini/
cp -r Gemini_plugin/dist/Gemini/* %{buildroot}%{_libexecdir}/Rack2/plugins/Gemini/
