...
%global commit0 47333be1c11e3dd3da63439bae9162b509710058
...
URL:     https://github.com/animatek/UZZ-VCV-RACK
...
Source0: Rack.tar.gz
Source1: https://github.com/animatek/UZZ-VCV-RACK/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Animatek_plugin.json
...
mkdir Animatek_plugin
tar xvfz %{SOURCE1} --directory=Animatek_plugin --strip-components=1

cp -n %{SOURCE2} Animatek_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Animatek/
cp -r Animatek_plugin/dist/Animatek/* %{buildroot}%{_libexecdir}/Rack2/plugins/Animatek/
