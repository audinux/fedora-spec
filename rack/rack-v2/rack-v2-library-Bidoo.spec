...
%global commit0 e58e2230496170d544a1bbea742d290dfb4fb10c
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Bidoo/
cp -r Bidoo_plugin/dist/Bidoo/* %{buildroot}%{_libexecdir}/Rack2/plugins/Bidoo/
