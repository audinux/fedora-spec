...
%global commit0 9c3c0169d6be9ba1cb7955017141cb0b47986927
%global gittag0 2.14.5
...
Source0: Rack.tar.gz
Source1: https://github.com/DaveBenham/VenomModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Venom_plugin.json
...
%description
Venom plugin for Rack.
Hybrid polyphonic Attack,Decay and Attack,Sustain,Release envelope generator with looping capabilities
...
mkdir Venom_plugin
tar xvfz %{SOURCE1} --directory=Venom_plugin --strip-components=1

cp -n %{SOURCE2} Venom_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Venom/
cp -r Venom_plugin/dist/Venom/* %{buildroot}%{_libexecdir}/Rack2/plugins/Venom/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.14.5-1
- initial specfile
