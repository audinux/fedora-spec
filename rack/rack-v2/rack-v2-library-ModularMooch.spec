...
URL: https://github.com/WesDaMooch/Modular-Mooch-VCV
...
Source0: Rack.tar.gz
Source1: https://github.com/WesDaMooch/Modular-Mooch-VCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: ModularMooch_plugin.json
...
mkdir ModularMooch_plugin
tar xvfz %{SOURCE1} --directory=ModularMooch_plugin --strip-components=1

cp -n %{SOURCE2} ModularMooch_plugin/plugin.json || true

%build

cd ModularMooch_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ModularMooch/
cp -r ModularMooch_plugin/dist/ModularMooch/* %{buildroot}%{_libexecdir}/Rack2/plugins/ModularMooch/
