...
cp -n %{SOURCE2} luckyxxl_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/luckyxxl/
cp -r luckyxxl_plugin/dist/luckyxxl/* %{buildroot}%{_libexecdir}/Rack2/plugins/luckyxxl/
