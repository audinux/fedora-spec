...
%global commit0 71968f49aa8ac69fbd97d8fdfb7b8ac394a148de
%global gittag0 2.0.34
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/PS-PurrSoftware/
cp -r PS-PurrSoftware_plugin/dist/PS-PurrSoftware/* %{buildroot}%{_libexecdir}/Rack2/plugins/PS-PurrSoftware/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.0.34-1
- initial specfile
