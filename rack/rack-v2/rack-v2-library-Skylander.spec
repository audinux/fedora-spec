...
%global commit0 7c971272ec274a13eb6e8954f4d06b98269979b3
...
Name:    rack-v2-Skylander
Version: 2.1.0
Release: 1%{?dist}
Summary: Skylander plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/theskylander/Skylander-plugins
...
Source0: Rack.tar.gz
Source1: https://github.com/theskylander/Skylander-plugins/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Skylander_plugin.json
...
mkdir Skylander_plugin
tar xvfz %{SOURCE1} --directory=Skylander_plugin --strip-components=1

cp -n %{SOURCE2} Skylander_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Skylander/
cp -r Skylander_plugin/dist/Skylander/* %{buildroot}%{_libexecdir}/Rack2/plugins/Skylander/
