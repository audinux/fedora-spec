...
cp -n %{SOURCE2} Qwelk_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Qwelk/
cp -r Qwelk_plugin/dist/Qwelk/* %{buildroot}%{_libexecdir}/Rack2/plugins/Qwelk/
