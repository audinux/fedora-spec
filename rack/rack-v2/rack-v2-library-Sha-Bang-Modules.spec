...
%global commit0 f2cea419bb299fedc4683b7195027e5749006f6b
...
cp -n %{SOURCE2} Sha-Bang-Modules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Sha-Bang-Modules/
cp -r Sha-Bang-Modules_plugin/dist/Sha-Bang-Modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/Sha-Bang-Modules/
