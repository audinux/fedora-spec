...
cp -n %{SOURCE2} huaba_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/huaba/
cp -r huaba_plugin/dist/huaba/* %{buildroot}%{_libexecdir}/Rack2/plugins/huaba/
