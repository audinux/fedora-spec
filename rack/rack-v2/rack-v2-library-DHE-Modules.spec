...
%global commit0 1d1c286fc69babdb36dfe5fa4fe2856b0f707854
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/DHE-Modules/
cp -r DHE-Modules_plugin/dist/DHE-Modules/* %{buildroot}%{_libexecdir}/Rack2/plugins/DHE-Modules/
