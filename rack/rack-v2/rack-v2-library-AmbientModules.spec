...
%global commit0 af347bd635fadadafe65d8ca0b731f686ac70a8f
...
URL: https://github.com/neilbgr/AmbientModules
...
Source0: Rack.tar.gz
Source1: https://github.com/neilbgr/AmbientModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AmbientModules_plugin.json
...
%description
AmbientModules plugin for Rack.
Blank module
...
mkdir AmbientModules_plugin
tar xvfz %{SOURCE1} --directory=AmbientModules_plugin --strip-components=1

cp -n %{SOURCE2} AmbientModules_plugin/plugin.json || true

%build

cd AmbientModules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AmbientModules/
cp -r AmbientModules_plugin/dist/AmbientModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/AmbientModules/
