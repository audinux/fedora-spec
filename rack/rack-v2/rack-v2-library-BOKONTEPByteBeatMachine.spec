...
Name:    rack-v2-BOKONTEPByteBeatMachine
Version: 0.6.1
Release: 1%{?dist}
...
cp -n %{SOURCE2} BOKONTEPByteBeatMachine_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/BOKONTEPByteBeatMachine/
cp -r BOKONTEPByteBeatMachine_plugin/dist/BOKONTEPByteBeatMachine/* %{buildroot}%{_libexecdir}/Rack2/plugins/BOKONTEPByteBeatMachine/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 0.6.1-1
- initial specfile
