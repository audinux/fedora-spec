...
cp -n %{SOURCE2} WrongPeople_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/WrongPeople/
cp -r WrongPeople_plugin/dist/WrongPeople/* %{buildroot}%{_libexecdir}/Rack2/plugins/WrongPeople/
