...
%global commit0 553fa27b91cd3db22b11ab7b37dd17f96ee6e855
...
Name:    rack-v2-DigitalAtavism
Version: 2.0.0
Release: 2%{?dist}
Summary: DigitalAtavism plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/lazerfalcon/DigitalAtavism
...
Source0: Rack.tar.gz
Source1: https://github.com/lazerfalcon/DigitalAtavism/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: DigitalAtavism_plugin.json
...
%description
DigitalAtavism plugin for Rack.
...
mkdir DigitalAtavism_plugin
tar xvfz %{SOURCE1} --directory=DigitalAtavism_plugin --strip-components=1

cp -n %{SOURCE2} DigitalAtavism_plugin/plugin.json || true

%build

cd DigitalAtavism_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/DigitalAtavism/
cp -r DigitalAtavism_plugin/dist/DigitalAtavism/* %{buildroot}%{_libexecdir}/Rack2/plugins/DigitalAtavism/
