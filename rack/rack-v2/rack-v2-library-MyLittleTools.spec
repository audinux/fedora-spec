...
cp -n %{SOURCE2} MyLittleTools_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MyLittleTools/
cp -r MyLittleTools_plugin/dist/MyLittleTools/* %{buildroot}%{_libexecdir}/Rack2/plugins/MyLittleTools/
