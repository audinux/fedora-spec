...
Source0: Rack.tar.gz
Source1: https://github.com/SteveRussell33/Prism/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
cp -n %{SOURCE2} Prism_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Prism/
cp -r Prism_plugin/dist/Prism/* %{buildroot}%{_libexecdir}/Rack2/plugins/Prism/
