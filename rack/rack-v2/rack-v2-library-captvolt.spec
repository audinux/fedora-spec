...
%global commit0 67cf46f4e61a32433ef737ce1a2122a5b1643527
...
cp -n %{SOURCE2} captvolt_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/captvolt/
cp -r captvolt_plugin/dist/captvolt/* %{buildroot}%{_libexecdir}/Rack2/plugins/captvolt/
