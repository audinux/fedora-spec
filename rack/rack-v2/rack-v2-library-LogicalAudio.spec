...
%global commit0 300b90aae2a136fbf809b059438f1ec65f317b7a
...
Name:    rack-v2-LogicalAudio
Version: 2.0.1
Release: 2%{?dist}
Summary: LogicalAudio plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/AgostoSound/LogicalAudio
...
Source0: Rack.tar.gz
Source1: https://github.com/AgostoSound/LogicalAudio/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: LogicalAudio_plugin.json
...
%description
LogicalAudio plugin for Rack.
Logic gate audio carrier.
...
mkdir LogicalAudio_plugin
tar xvfz %{SOURCE1} --directory=LogicalAudio_plugin --strip-components=1

cp -n %{SOURCE2} LogicalAudio_plugin/plugin.json || true

%build

cd LogicalAudio_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/LogicalAudio/
cp -r LogicalAudio_plugin/dist/LogicalAudio/* %{buildroot}%{_libexecdir}/Rack2/plugins/LogicalAudio/
