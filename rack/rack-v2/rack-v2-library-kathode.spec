...
%global commit0 4dd9d8bb2f6b91795dc5fc2688464921174a6ab6
...
Name:    rack-v2-kathode
Version: 2.0.0
Release: 2%{?dist}
Summary: kathode plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/ketodin/kathode
...
Source0: Rack.tar.gz
Source1: https://github.com/ketodin/kathode/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: kathode_plugin.json
...
%description
kathode plugin for Rack.
XY Lissajous oscilloscope visualizer with CV-controlled hue, gain, afterglow and rotation.
...
mkdir kathode_plugin
tar xvfz %{SOURCE1} --directory=kathode_plugin --strip-components=1

cp -n %{SOURCE2} kathode_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/kathode/
cp -r kathode_plugin/dist/kathode/* %{buildroot}%{_libexecdir}/Rack2/plugins/kathode/
