...
%global commit0 8be57aafcbb0d2b099ad6be9aedaeb2793a2d7e5
...
Version: 2.0.3
Release: 2%{?dist}
Summary: Bruer plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/bruer80/bruer-vcv
...
Source0: Rack.tar.gz
Source1: https://github.com/bruer80/bruer-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Bruer_plugin.json
...
%description
Bruer plugin for Rack.
Probabilistic Turing sequencer with integrated quantizer and Euclidean triggers
...
mkdir Bruer_plugin
tar xvfz %{SOURCE1} --directory=Bruer_plugin --strip-components=1

cp -n %{SOURCE2} Bruer_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Bruer/
cp -r Bruer_plugin/dist/Bruer/* %{buildroot}%{_libexecdir}/Rack2/plugins/Bruer/
