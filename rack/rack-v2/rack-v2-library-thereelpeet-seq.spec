...
mkdir thereelpeet-seq_plugin
tar xvfz %{SOURCE1} --directory=thereelpeet-seq_plugin --strip-components=1

cp -n %{SOURCE2} thereelpeet-seq_plugin/plugin.json || true

%build

cd thereelpeet-seq_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/thereelpeet-seq/
cp -r thereelpeet-seq_plugin/dist/thereelpeet-seq/* %{buildroot}%{_libexecdir}/Rack2/plugins/thereelpeet-seq/
