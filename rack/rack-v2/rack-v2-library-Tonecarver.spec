...
%global commit0 0bc4bd1eb78fc47a5c8c49cadeb985b2ac738197
...
Spectral Manipulator: Blur, Filter, Pitch, Gain, Robot
...
cp -n %{SOURCE2} Tonecarver_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Tonecarver/
cp -r Tonecarver_plugin/dist/Tonecarver/* %{buildroot}%{_libexecdir}/Rack2/plugins/Tonecarver/
