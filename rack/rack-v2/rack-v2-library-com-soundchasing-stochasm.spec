...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/com-soundchasing-stochasm/
cp -r com-soundchasing-stochasm_plugin/dist/com-soundchasing-stochasm/* %{buildroot}%{_libexecdir}/Rack2/plugins/com-soundchasing-stochasm/
