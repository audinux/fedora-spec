...
%global commit0 c3db83a58e98afbf37eee8b3235f8a69c69e4e8a
...
Name:    rack-v2-BlackNoiseModular
Version: 2.0.2
Release: 2%{?dist}
Summary: BlackNoiseModular plugin for Rack
...
Source0: Rack.tar.gz
Source1: https://github.com/BlackNoiseModular/VCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: BlackNoiseModular_plugin.json
...
%description
BlackNoiseModular plugin for Rack.
...
mkdir BlackNoiseModular_plugin
tar xvfz %{SOURCE1} --directory=BlackNoiseModular_plugin --strip-components=1

cp -n %{SOURCE2} BlackNoiseModular_plugin/plugin.json || true

%build

cd BlackNoiseModular_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/BlackNoiseModular/
cp -r BlackNoiseModular_plugin/dist/BlackNoiseModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/BlackNoiseModular/
