...
%global commit0 fe5a642ee0a455e882e105f422cf85f7e83fd31f
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/8Mode/
cp -r 8Mode_plugin/dist/8Mode/* %{buildroot}%{_libexecdir}/Rack2/plugins/8Mode/
