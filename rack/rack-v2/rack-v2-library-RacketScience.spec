...
cp -n %{SOURCE2} RacketScience_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RacketScience/
cp -r RacketScience_plugin/dist/RacketScience/* %{buildroot}%{_libexecdir}/Rack2/plugins/RacketScience/
