...
%global commit0 d8ffda55c59e2b40091c6437b115d114287073c1
...
Name:    rack-v2-nullpath
Version: 2.0.0
Release: 2%{?dist}
Summary: nullpath plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/alefnull/NullPath
...
Source0: Rack.tar.gz
Source1: https://github.com/alefnull/NullPath/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: nullpath_plugin.json
...
mkdir nullpath_plugin
tar xvfz %{SOURCE1} --directory=nullpath_plugin --strip-components=1 

cp -n %{SOURCE2} nullpath_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/nullpath/
cp -r nullpath_plugin/dist/nullpath/* %{buildroot}%{_libexecdir}/Rack2/plugins/nullpath/
