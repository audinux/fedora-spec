...
%global commit0 0178c638816eaab1112af0df223271c30d6bbe8b
...
Version: 2.0.0
Release: 2%{?dist}
Summary: Corpus plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/dungbeetlesisyphus/JamPG
...
Source0: Rack.tar.gz
Source1: https://github.com/dungbeetlesisyphus/JamPG/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Corpus_plugin.json
...
%description
Corpus plugin for Rack.
Image-to-rhythm sequencer — load any image, scan pixels into RGB gates and CV
...
mkdir Corpus_plugin
tar xvfz %{SOURCE1} --directory=Corpus_plugin --strip-components=1

cp -n %{SOURCE2} Corpus_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Corpus/
cp -r Corpus_plugin/dist/Corpus/* %{buildroot}%{_libexecdir}/Rack2/plugins/Corpus/
