...
%global commit0 1850526aa4ef5ce98c632e45de47e8223dab7370
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/trowaSoft/
cp -r trowaSoft_plugin/dist/trowaSoft/* %{buildroot}%{_libexecdir}/Rack2/plugins/trowaSoft/
