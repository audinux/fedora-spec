...
%global commit0 6651d58a191ecbc86255b3c60b4aca834f66f7bf
...
Name: rack-v2-VocalLamma
Version: 2.2.0
Release: 2%{?dist}
Summary: VocalLamma plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/SantiJay7/VocalLamma
...
Source0: Rack.tar.gz
Source1: https://github.com/SantiJay7/VocalLamma/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: VocalLamma_plugin.json
...
%description
VocalLamma plugin for Rack.
Formant vocal synthesizer (OO-OH-AH-AY-EE) with stereo ping-pong delay
...
mkdir VocalLamma_plugin
tar xvfz %{SOURCE1} --directory=VocalLamma_plugin --strip-components=1

cp -n %{SOURCE2} VocalLamma_plugin/plugin.json || true

%build

cd VocalLamma_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/VocalLamma/
cp -r VocalLamma_plugin/dist/VocalLamma/* %{buildroot}%{_libexecdir}/Rack2/plugins/VocalLamma/
