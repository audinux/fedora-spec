...
%global commit0 3310de2c9b343a1413f1db5951b387c7fd3c70eb
...
cp -n %{SOURCE2} Chiptuner_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Chiptuner/
cp -r Chiptuner_plugin/dist/Chiptuner/* %{buildroot}%{_libexecdir}/Rack2/plugins/Chiptuner/
