...
%global commit0 d22191a9c5e3e9f01a9ee5beab7cb876ce6aab49
...
Name: rack-v2-Sticksy
Version: 2.0.0
Release: 2%{?dist}
Summary: Sticksy plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/infamedavid/Sticksy-rack
...
Source0: Rack.tar.gz
Source1: https://github.com/infamedavid/Sticksy-rack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Sticksy_plugin.json
...
%description
Sticksy plugin for Rack.
Decorative blank panel.
...
mkdir Sticksy_plugin
tar xvfz %{SOURCE1} --directory=Sticksy_plugin --strip-components=1

cp -n %{SOURCE2} Sticksy_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Sticksy/
cp -r Sticksy_plugin/dist/Sticksy/* %{buildroot}%{_libexecdir}/Rack2/plugins/Sticksy/
