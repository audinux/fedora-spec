...
%global commit0 4faae4fbc5afc88275ce5fc11c25e28d7c1396fc
...
cp -n %{SOURCE2} NonlinearCircuits_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NonlinearCircuits/
cp -r NonlinearCircuits_plugin/dist/NonlinearCircuits/* %{buildroot}%{_libexecdir}/Rack2/plugins/NonlinearCircuits/
