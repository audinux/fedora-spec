...
cp -n %{SOURCE2} MicMusic_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/MicMusic/
cp -r MicMusic_plugin/dist/MicMusic/* %{buildroot}%{_libexecdir}/Rack2/plugins/MicMusic/
