...
%global commit0 853af138c76e87b985d91ed720df89d321aaf61a
...
Source0: Rack.tar.gz
Source1: https://github.com/kockie69/SquinkyVCV-main/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: squinkylabs-plug1_plugin.json
Patch0: rack-v2-aarch64.patch
Patch1: rack-v2-library-squinkylabs-plug1-aarch64.patch
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/squinkylabs-plug1/
cp -r squinkylabs-plug1_plugin/dist/squinkylabs-plug1/* %{buildroot}%{_libexecdir}/Rack2/plugins/squinkylabs-plug1/
