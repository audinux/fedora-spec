...
%global commit0 6c70bcc61e1dcb5b93af8cafa8e3720dd89ed943
...
Source0: Rack.tar.gz
Source1: https://github.com/lancemgiles/Dogman-Devices-Rack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: DogmanDevices_plugin.json
...
%description
DogmanDevices plugin for Rack.
Tidally locked tremolo and chorus. Hardware emulation
...
mkdir DogmanDevices_plugin
tar xvfz %{SOURCE1} --directory=DogmanDevices_plugin --strip-components=1

cp -n %{SOURCE2} DogmanDevices_plugin/plugin.json || true

%build

cd DogmanDevices_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/DogmanDevices/
cp -r DogmanDevices_plugin/dist/DogmanDevices/* %{buildroot}%{_libexecdir}/Rack2/plugins/DogmanDevices/
