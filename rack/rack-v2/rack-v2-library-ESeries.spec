...
%global commit0 cb665989f48db6c4fe96924b9e42c804ee15d5cf
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ESeries/
cp -r ESeries_plugin/dist/ESeries/* %{buildroot}%{_libexecdir}/Rack2/plugins/ESeries/
