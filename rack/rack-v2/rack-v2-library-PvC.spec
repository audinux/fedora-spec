...
cp -n %{SOURCE2} PvC_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/PvC/
cp -r PvC_plugin/dist/PvC/* %{buildroot}%{_libexecdir}/Rack2/plugins/PvC/
