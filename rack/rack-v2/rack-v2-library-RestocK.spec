...
%global commit0 8f0af8c3f571511692158bdef143999046facd06
...
URL:     https://github.com/shortwavlabs/vcv-restoch-plugins
...
Source0: Rack.tar.gz
Source1: https://github.com/shortwavlabs/vcv-restoch-plugins/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: RestocK_plugin.json
...
%description
RestocK plugin for Rack.
A stochastic synthesis generator.
...
mkdir RestocK_plugin
tar xvfz %{SOURCE1} --directory=RestocK_plugin --strip-components=1

cp -n %{SOURCE2} RestocK_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RestocK/
cp -r RestocK_plugin/dist/RestocK/* %{buildroot}%{_libexecdir}/Rack2/plugins/RestocK/
