...
cp -n %{SOURCE2} Stalys_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Stalys/
cp -r Stalys_plugin/dist/Stalys/* %{buildroot}%{_libexecdir}/Rack2/plugins/Stalys/
