...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Sculpt-O-Sound/
cp -r Sculpt-O-Sound_plugin/dist/Sculpt-O-Sound/* %{buildroot}%{_libexecdir}/Rack2/plugins/Sculpt-O-Sound/
