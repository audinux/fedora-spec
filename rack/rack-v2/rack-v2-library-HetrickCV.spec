...
%global commit0 9caccda45ede32a7669214c265c4120eedb79014
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/HetrickCV/
cp -r HetrickCV_plugin/dist/HetrickCV/* %{buildroot}%{_libexecdir}/Rack2/plugins/HetrickCV/
