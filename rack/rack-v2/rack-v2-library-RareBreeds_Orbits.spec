...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/RareBreeds_Orbits/
cp -r RareBreeds_Orbits_plugin/dist/RareBreeds_Orbits/* %{buildroot}%{_libexecdir}/Rack2/plugins/RareBreeds_Orbits/
