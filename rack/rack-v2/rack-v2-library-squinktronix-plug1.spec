...
%global commit0 fa308c0b704f3d16f6be3f1871ed8500c9f6d755
...
Source0: Rack.tar.gz
Source1: https://github.com/squinkylabs/SqHarmony/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: squinktronix-plug1_plugin.json
...
%description
squinktronix-plug1 plugin for Rack.
Harmony Generator
...
mkdir squinktronix-plug1_plugin
tar xvfz %{SOURCE1} --directory=squinktronix-plug1_plugin --strip-components=1

cp -n %{SOURCE2} squinktronix-plug1_plugin/plugin.json || true

%build

cd squinktronix-plug1_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/squinktronix-plug1/
cp -r squinktronix-plug1_plugin/dist/squinktronix-plug1/* %{buildroot}%{_libexecdir}/Rack2/plugins/squinktronix-plug1/
