...
%global commit0 8d4a4556569ddeda2bab251e092cb72acd314195
...
Name:    rack-v2-FrequencyDomain
Version: 2.0.3
Release: 2%{?dist}
Summary: FrequencyDomain plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/almostEric/Frequency-Domain
...
Source0: Rack.tar.gz
Source1: https://github.com/almostEric/Frequency-Domain/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: FrequencyDomain_plugin.json
...
%description
FrequencyDomain plugin for Rack.
...
mkdir FrequencyDomain_plugin
tar xvfz %{SOURCE1} --directory=FrequencyDomain_plugin --strip-components=1

cp -n %{SOURCE2} FrequencyDomain_plugin/plugin.json || true

%build

cd FrequencyDomain_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/FrequencyDomain/
cp -r FrequencyDomain_plugin/dist/FrequencyDomain/* %{buildroot}%{_libexecdir}/Rack2/plugins/FrequencyDomain/
