...
Name:    rack-v2-ErraticInstruments
Version: 0.6.2
Release: 1%{?dist}
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ErraticInstruments/
cp -r ErraticInstruments_plugin/dist/ErraticInstruments/* %{buildroot}%{_libexecdir}/Rack2/plugins/ErraticInstruments/
