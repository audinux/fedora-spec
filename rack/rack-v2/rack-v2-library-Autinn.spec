...
%global commit0 eff448f818f7ca94c6a893b69a907fcf45f0a639
%global gittag0 2.6.32
...
Source0: Rack.tar.gz
Source1: https://github.com/NikolaiVChr/Autinn/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Autinn_plugin.json
...
mkdir Autinn_plugin
tar xvfz %{SOURCE1} --directory=Autinn_plugin --strip-components=1

cp -n %{SOURCE2} Autinn_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Autinn/
cp -r Autinn_plugin/dist/Autinn/* %{buildroot}%{_libexecdir}/Rack2/plugins/Autinn/

%files
%{_libexecdir}/*

%changelog
* Tue Nov 30 2021 Yann Collette <ycollette.nospam@free.fr> - 2.6.32-1
- initial specfile
