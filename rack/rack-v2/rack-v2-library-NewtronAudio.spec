...
%global commit0 e6aebeace6f68fc71f83879b0abc4e82861185de
...
Name:    rack-v2-NewtronAudio
Version: 2.0.1
Release: 2%{?dist}
Summary: NewtronAudio plugin for Rack
License: GPL-2.0-or-later
URL:     https://github.com/zebedeezac/NewtronAudio
...
Source0: Rack.tar.gz
Source1: https://github.com/zebedeezac/NewtronAudio/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: NewtronAudio_plugin.json
...
%description
NewtronAudio plugin for Rack.
Spices up a incoming signal by varying pitch and gate length in real time
...
mkdir NewtronAudio_plugin
tar xvfz %{SOURCE1} --directory=NewtronAudio_plugin --strip-components=1

cp -n %{SOURCE2} NewtronAudio_plugin/plugin.json || true

%build

cd NewtronAudio_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/NewtronAudio/
cp -r NewtronAudio_plugin/dist/NewtronAudio/* %{buildroot}%{_libexecdir}/Rack2/plugins/NewtronAudio/
