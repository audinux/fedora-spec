...
cp -n %{SOURCE2} KarateSnoopy_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/KarateSnoopy/
cp -r KarateSnoopy_plugin/dist/KarateSnoopy/* %{buildroot}%{_libexecdir}/Rack2/plugins/KarateSnoopy/
