...
License: GPLv2+
URL:     https://github.com/aetrion-music/aetrion-modular
...
Source0: Rack.tar.gz
Source1: https://github.com/aetrion-music/aetrion-modular/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AetrionModular_plugin.json
...
%description
AetrionModular plugin for Rack.
...
cd AetrionModular_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AetrionModular/
cp -r AetrionModular_plugin/dist/AetrionModular/* %{buildroot}%{_libexecdir}/Rack2/plugins/AetrionModular/
