...
%global commit0 ed72dd18180b6bed4dcc9b14f947d20299123ae6
...
Name:    rack-v2-ChortlingHamsterModules
Version: 2.0.0
Release: 1%{?dist}
...
cp -n %{SOURCE2} ChortlingHamsterModules_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/ChortlingHamsterModules/
cp -r ChortlingHamsterModules_plugin/dist/ChortlingHamsterModules/* %{buildroot}%{_libexecdir}/Rack2/plugins/ChortlingHamsterModules/
