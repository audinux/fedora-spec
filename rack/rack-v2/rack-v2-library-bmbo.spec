...
URL: https://github.com/kamlaktaye/BmboBTFQuantizer
...
Source0: Rack.tar.gz
Source1: https://github.com/kamlaktaye/BmboBTFQuantizer/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: bmbo_plugin.json
...
mkdir bmbo_plugin
tar xvfz %{SOURCE1} --directory=bmbo_plugin --strip-components=1

cp -n %{SOURCE2} bmbo_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/bmbo/
cp -r bmbo_plugin/dist/bmbo/* %{buildroot}%{_libexecdir}/Rack2/plugins/bmbo/
