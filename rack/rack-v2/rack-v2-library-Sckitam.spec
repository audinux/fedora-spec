...
%global commit0 5bf0ca542be9fe010a53a30a4b6e2e28770d690d
...
cp -n %{SOURCE2} Sckitam_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Sckitam/
cp -r Sckitam_plugin/dist/Sckitam/* %{buildroot}%{_libexecdir}/Rack2/plugins/Sckitam/
