...
Source0: Rack.tar.gz
Source1: https://github.com/demcanulty/Yokai_Holiday//archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Yokai_Holiday_plugin.json
...
cd Yokai_Holiday_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/Yokai_Holiday/
cp -r Yokai_Holiday_plugin/dist/Yokai_Holiday/* %{buildroot}%{_libexecdir}/Rack2/plugins/Yokai_Holiday/
