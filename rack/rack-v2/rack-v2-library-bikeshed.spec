...
%global commit0 4818f9ac9a92ffce921e4278faeac26ba6ea8f6e
...
Name: rack-v2-bikeshed
Version: 2.1.2
Release: 2%{?dist}
Summary: bikeshed plugin for Rack
License: GPL-2.0-or-later
URL: https://github.com/marionm/bikeshed-vcv-rack
...
Source0: Rack.tar.gz
Source1: https://github.com/marionm/bikeshed-vcv-rack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: bikeshed_plugin.json
...
%description
bikeshed plugin for Rack.
Indexable randomness
...
mkdir bikeshed_plugin
tar xvfz %{SOURCE1} --directory=bikeshed_plugin --strip-components=1

cp -n %{SOURCE2} bikeshed_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/bikeshed/
cp -r bikeshed_plugin/dist/bikeshed/* %{buildroot}%{_libexecdir}/Rack2/plugins/bikeshed/
