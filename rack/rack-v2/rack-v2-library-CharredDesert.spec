...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/CharredDesert/
cp -r CharredDesert_plugin/dist/CharredDesert/* %{buildroot}%{_libexecdir}/Rack2/plugins/CharredDesert/
