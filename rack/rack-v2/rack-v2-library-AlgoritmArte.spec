...
%global commit0 ca18fd721f73afc4ae6988bb4c24f061691f24c4
...
cp -n %{SOURCE2} AlgoritmArte_plugin/plugin.json || true
...
mkdir -p %{buildroot}%{_libexecdir}/Rack2/plugins/AlgoritmArte/
cp -r AlgoritmArte_plugin/dist/AlgoritmArte/* %{buildroot}%{_libexecdir}/Rack2/plugins/AlgoritmArte/
